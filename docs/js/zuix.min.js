...
d.prototype.on=function(e,a){var c=e.match(/\S+/g)||[];this.each(function(e,b){k.each(c,function(e,c){f(b,c,a)})});return this};d.prototype.off=function(e,a){var b=e.match(/\S+/g)||[];this.each(function(e,d){k.each(b,function(e,b){c(d,b,a)})});return this};d.prototype.isEmpty=function(){return 0===this._selection[0].innerHTML.replace(/\s/g,"").length};d.prototype.position=function(){return null!=this._selection[0]?k.getPosition(this._selection[0]):{x:-1,y:-1,visible:!1}};d.prototype.css=function(e,
a){if(g.isNoU(a))return this._selection[0].style[e];this.each(function(c,b){b.style[e]=a});return this};d.prototype.addClass=function(a){var c=a.match(/\S+/g)||[];k.each(this._selection,function(b,d){d.classList?k.each(c,function(a,e){d.classList.add(e)}):d.className+=" "+a});return this};d.prototype.hasClass=function(a){return k.hasClass(this._selection[0],a)};d.prototype.removeClass=function(a){var c=a.match(/\S+/g)||[];k.each(this._selection,function(b,d){d.classList?k.each(c,function(a,e){d.classList.remove(e)}):
...
a.prototype=window.Event.prototype;window.CustomEvent=a})();n.exports=k},{"./Util.js":2}],4:[function(m,n,p){m=m("./zuix/Zuix.js");"object"===typeof n&&n.exports?n.exports=m.call(this):this.zuix=m.call(this)},{"./zuix/Zuix.js":7}],5:[function(m,n,p){function b(a,b){this._options=null;this.contextId=null==a||null==a.contextId?null:a.contextId;this.componentId=null;this.trigger=function(a,c,k){"function"===typeof b&&b(a,c,k)};this.behavior=this._controller=this._style=this._css=this._view=this._model=
