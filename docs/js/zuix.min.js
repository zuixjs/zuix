...
b){const h=f.dom.queryAttribute(g.dataUiComponent);for(let b of a)"childList"===b.type&&b.addedNodes.forEach(function(a){if(a instanceof Element){let d=zuix.$(a).parent(h);if(null!=d.get())if(!1!==c.options().css&&null==d.attr("_ctrl_")){if(d.get()===c._container||d.get()===c._view){var b=!1;for(var e=0;e<a.attributes.length;e++)if(a.attributes[e].name.startsWith("_css_")){b=!0;break}b||f.dom.setAttribute(a,c.getCssId(),"")}}else{b=0;do b++,d=d.parent(h);while(10>b&&null!=d.get()&&null!=d.attr("_ctrl_"));
if(d.get()){d=zuix.context(d);b=!1;for(e=0;e<a.attributes.length;e++)if(a.attributes[e].name.startsWith("_css_")){b=!0;break}b||(f.dom.setAttribute(a,d.getCssId(),""),zuix.$(a).find("*").each(function(){this.attr(d.getCssId(),"")}))}}}})}}const g=m("./OptionAttributes"),f=m("../helpers/Util");c.prototype.start=function(){this.stop();this._mutationObserver=new MutationObserver(this._mutationCallback);this._mutationObserver.observe(this._context._view,{attributes:!1,childList:!0,subtree:!0})};c.prototype.stop=
function(){null!=this._mutationObserver&&(this._mutationObserver.disconnect(),this._mutationObserver=null)};q.exports=c},{"../helpers/Util":4,"./OptionAttributes":14}],16:[function(m,q,w){function c(){x.setHost(this);this._store=[];this._fieldCache=[];return this}function g(a){"function"!==typeof a["for"]&&(a["for"]=function(b){return M[b]=a});return a}function f(a,b,c){t.isNoU(c)&&(c=this);null==c._fieldCache&&(c._fieldCache={});let d=null;"undefined"===typeof c._fieldCache[a]?(d=p(b).find(t.dom.queryAttribute(B.dataUiField,
