...
A(a.componentId)){var b=f.wrapElement("div",a.view().outerHTML);w.push({componentId:a.componentId,view:b.innerHTML,controller:a.controller()})}f(a.view()).one("create",function(){if(e.isFunction(a.controller())){var b=a._c=new k(a);e.isNoU(b.view())||f(b.view()).attr("data-ui-component",b.componentId);e.isFunction(b.create)&&b.create();e.isFunction(b.resume)&&b.resume();e.isFunction(b.refresh)&&b.refresh()}e.isFunction(a.ready)&&a.ready(a)}).trigger("create")}}function F(a){var b=function(a){};"string"===
...
this.style(a.css),this.model(a.model),this.controller(a.controller));return this};d.prototype.ready=function(a){};d.prototype.error=function(a,b){};d.prototype.on=function(a,b){return this._c.on(a,b)};d.prototype.invoke=function(a,b){return this._c.invoke(a,b)};d.prototype.model=function(a){if("undefined"===typeof a)return this._model;this._model=a;this.updateModelView();return this};d.prototype.updateModelView=function(){if(!e.isNoU(this._view)&&!e.isNoU(this._model)){var a=this;f(this._view).find("[data-ui-field]").each(function(b,
...
Element.prototype.oMatchesSelector||Element.prototype.webkitMatchesSelector||function(b){b=(this.document||this.ownerDocument).querySelectorAll(b);for(var c=b.length;0<=--c&&b.item(c)!==this;);return-1<c});for(;b&&b!==document;b=b.parentNode)if(b.matches(c))return b;return null};this.zuix=this.zuix||{controller:l,load:q,unload:E,componentize:n,hook:function(b,c){H(b,c);return this},$:f,field:m,TaskQueue:y,ZQuery:g,dumpCache:function(){console.log("ZUIX","Component Cache",w)},dumpContexts:function(){console.log("ZUIX",
