...
d(this.view()).find("[data-ui-field="+b+"]").get(0),null!=f&&(this._fieldCache[e]=f)):f=this._fieldCache[e];return f};b.prototype.clearCache=function(){this._fieldCache.length=0};g.exports=b},{"../helpers/ZxQuery":3}],7:[function(e,g,k){var b=e("../helpers/Util"),d=e("../helpers/TaskQueue"),c=e("../helpers/ZxQuery");g.exports=function(){function a(b){n.requestLock(a)?(c(b).find("[data-ui-load]:not([data-ui-loaded=true]),[data-ui-include]:not([data-ui-loaded=true])").each(function(){if("true"===this.getAttribute("data-ui-forceload"))return g(this),
!0;var b=c.getClosest(this,"[data-ui-lazyload=true]");if(null!==b&&(-1==z.indexOf(b)&&(z.push(b),c(b).on("scroll",function(){a(b)})),!c.getPosition(this).visible))return-1==p.indexOf(this)&&p.push(this),!0;var d=p.indexOf(this);-1<d&&p.splice(d,1);g(this)}),n.releaseLock(a)):n.lockLater(a,function(){a(b)},200)}function g(a){var d=c(a);if("true"===d.attr("data-ui-loaded")||0<d.parent("pre,code").length())console.log("ZUIX","WARN","Skipped",a);else{d.attr("data-ui-loaded","true");var e=d.attr("data-ui-options");
b.isNoU(e)?e={}:(e=b.propertyFromPath(window,e),e=b.cloneObject(e)||{});b.isNoU(e.view)&&!d.isEmpty()?e.view=a:b.isNoU(e.view)&&b.isNoU(e.container)&&d.isEmpty()&&(e.container=a);a=d.attr("data-ui-load");b.isNoU(a)&&(a=d.attr("data-ui-include"),d.attr("data-ui-component",a),b.isNoU(e.controller)&&(e.controller=function(){}));d=d.attr("data-bind-model");!b.isNoU(d)&&0<d.length&&(e.model=b.propertyFromPath(window,d));f(a,e)}}function f(a,d){var e=null;b.isNoU(d)?(d={},e=new A(d,v)):b.isNoU(d.contextId)?
(!1===d&&(d={}),d.contextId="zuix-ctx-"+ ++C,e=y(d)):(e=k(d.contextId),null!==e?e.options(d):e=y(d));e.componentId!=a&&(e.componentId=a);var f=l(e.componentId);null!==f&&b.isNoU(e.controller())&&e.controller(f.controller);b.isFunction(d.ready)&&(e.ready=d.ready);b.isFunction(d.error)&&(e.error=d.error);if(b.isNoU(d.view)){if(null!==f?e.view(f.view):(f=c().find('[data-ui-view="'+e.componentId+'"]'),0<f.length()&&e.view(f.get(0))),b.isNoU(e.view()))return n.queue("html:"+e.componentId,function(){var a=
this;c.ajax({url:e.componentId+".html?"+(new Date).getTime(),success:function(b){e.view(b);a.end();!1!==d.css?B(e,function(){t(e)}):t(e)},error:function(c){a.end();console.log(c,e);b.isFunction(d.error)&&e.error(e,c)}})}),e}else e.view(d.view);t(e);return e}function k(a){var d=null;c.each(w,function(c,e){if(a instanceof Node&&e.view()===a||b.objectEquals(e.contextId,a))return d=e,!1});return d}function y(a){a=new A(a,v);w.push(a);return a}function l(a){var d=null;c.each(x,function(c,e){if(b.objectEquals(e.componentId,
a))return d=e,!1});return d}function B(a,d){n.queue("css:"+a.componentId,function(){var e=this;c.ajax({url:a.componentId+".css?"+(new Date).getTime(),success:function(c){a.style(c);e.end();b.isFunction(d)&&d.call(a)},error:function(c){e.end();console.log(c,a);b.isFunction(d)&&d.call(a)}})})}function t(a){"undefined"===typeof a.options().controller&&null===a.controller()?n.queue("js:"+a.componentId,function(){var d=this;c.ajax({url:a.componentId+".js?"+(new Date).getTime(),success:function(c){try{var e=
c.indexOf(".load");1<e&&(c=c.substring(0,e-4));var f=c.indexOf(".controller");1<f&&(c=c.substring(f+11));a.controller(D(c))}catch(g){console.log(g,c,a);b.isFunction(a.error)&&a.error(a,g);return}u(a);d.end()},error:function(c){d.end();u(a);console.log(c,a);b.isFunction(a.error)&&a.error(a,c)}})}):u(a)}function u(a){if(!b.isNoU(a.view())){if(null===l(a.componentId)){var d=a.view()===a.container()?a.view().innerHTML:a.view().outerHTML,d=c.wrapElement("div",d);x.push({componentId:a.componentId,view:d.innerHTML,
controller:a.controller()})}b.isFunction(a.controller())&&(d=a._c=new E(a),b.isNoU(d.view())||d.view().setAttribute("data-ui-component",d.componentId),b.isFunction(d.create)&&d.create(),d.trigger("view:create"),a.updateModelView(),b.isFunction(d.resume)&&d.resume());b.isFunction(a.ready)&&a.ready(a)}}function D(a){var b=function(a){};"string"===typeof a&&(b=eval.call(this,a));return b}function v(c,d,e){b.isFunction(q[d])&&q[d].call(c,d,e);"view:process"==d&&a(e)}function F(a,c){if(b.isNoU(c))return q[a];
q[a]=c;return this}var A=e("./ComponentContext"),E=e("./ContextController"),n=new d(function(a,b,c){v(a,b,c)}),x=[],w=[],C=0,p=[],z=[],q=[];return{controller:function(a){return a},load:f,unload:function(a){b.isNoU(a)||b.isNoU(a._c)||(b.isNoU(a._c.view())||a._c.view().removeAttribute("data-ui-component"),b.isFunction(a._c.destroy)&&a._c.destroy())},componentize:a,context:k,hook:function(a,b){F(a,b);return this},$:c,field:function(a,b){return c(b).find('[data-ui-field="'+a+'"]').get(0)},TaskQueue:d,
ZxQuery:c.ZxQuery,dumpCache:function(){console.log("ZUIX","Component Cache",x)},dumpContexts:function(){console.log("ZUIX","Loaded Component Instances",w)}}}},{"../helpers/TaskQueue":1,"../helpers/Util":2,"../helpers/ZxQuery":3,"./ComponentContext":5,"./ContextController":6}]},{},[4])(4)});
