...
b);return this};h.prototype.css=function(b,c){if(e.isNoU(c))return this._selection[0].style[b];this.each(function(f,d){this.style[b]=c});return this};h.prototype.attr=function(b,c){if(e.isNoU(c))return this._selection[0].getAttribute(b);this.each(function(f,d){this.setAttribute(b,c)});return this};h.prototype.trigger=function(b,c){var f;window.CustomEvent?f=new CustomEvent(b,{detail:c}):(f=document.createEvent("CustomEvent"),f.initCustomEvent(b,!0,!0,c));this.each(function(b,c){this.dispatchEvent(f)});
return this};h.prototype.one=function(b,c){var f=!1;this.on(b,function(d,e){f||(f=!0,g(this).off(b,c),c.call(this,d,e))});return this};h.prototype.on=function(b,c){var d=b.match(/\S+/g)||[];this.each(function(b,f){var e=this;g.each(d,function(b,d){e.addEventListener(d,c,!1)})});return this};h.prototype.off=function(b,c){var d=b.match(/\S+/g)||[];this.each(function(b,f){var e=this;g.each(d,function(b,d){e.removeEventListener(d,c)})});return this};h.prototype.isEmpty=function(){return 0===this._selection[0].innerHTML.replace(/\s/g,
"").length};h.prototype.css=function(b,c){if(e.isNoU(c))return this._selection[0].style[b];this.each(function(d,e){this.style[b]=c});return this};h.prototype.addClass=function(b){var c=b.match(/\S+/g)||[];g.each(this._selection,function(d,e){if(this.classList){var f=this;g.each(c,function(b,c){f.classList.add(c)})}else this.className+=" "+b});return this};h.prototype.hasClass=function(b){b=b.match(/\S+/g)||[];var c=!1,d=this._selection[0];g.each(b,function(b,f){if(c=d?d.classList.contains(f):(new RegExp("(^| )"+
f+"( |$)","gi")).test(d.className))return!1});return c};h.prototype.removeClass=function(b){var c=b.match(/\S+/g)||[];g.each(this._selection,function(d,e){if(this.classList){var f=this;g.each(c,function(b,c){f.classList.remove(c)})}else this.className=this.className.replace(new RegExp("(^|\\b)"+b.split(" ").join("|")+"(\\b|$)","gi")," ")});return this};h.prototype.prev=function(){return new h(this._selection[0].previousElementSibling)};h.prototype.next=function(){return new h(this._selection[0].nextElementSibling)};
h.prototype.html=function(b){if(e.isNoU(b))return this._selection[0].innerHTML;this.each(function(c,d){this.innerHTML=b});return this};h.prototype.display=function(b){g.each(this._selection,function(c,d){this.style.display=b});return this};h.prototype.show=function(){return this.display("")};h.prototype.hide=function(){return this.display("none")};var g=function(b){return new h(b)};g.find=function(b){return g().find(b)};g.each=function(b,c){for(var d=0,e=b.length;d<e&&!1!==c.call(b[d],d,b[d]);d++);
return this};g.ajax=function(b){var c;c=e.isNoU(b)||e.isNoU(b.url)?b:b.url;var d=new XMLHttpRequest;d.open("GET",c);d.onload=function(){200===d.status?e.isFunction(b.success)&&b.success(d.responseText):e.isFunction(b.error)&&b.error(d)};d.send();return this};g.wrapElement=function(b,c){b=document.createElement(b);"string"===typeof c?b.innerHTML=c:b.appendChild(c);return b};g.wrapCss=function(b,c){for(var d=/([.,\w])([^/{};]+)({)/g,e,g=null,h="";e=d.exec(c);)null!=g&&(h+=b+" "+c.substring(g.index,
e.index)),g=e;null!=g&&(h+=b+" "+c.substring(g.index));""!=h&&(c=h);return c};g.appendCss=function(b,c){var d=null,g;"string"===typeof b?(g=document.head||document.getElementsByTagName("head")[0],d=document.createElement("style"),d.type="text/css",d.styleSheet?d.styleSheet.cssText=b:d.appendChild(document.createTextNode(b))):b instanceof Element&&(d=b);e.isNoU(c)||g.removeChild(c);e.isNoU(d)||g.appendChild(d);return d};g.getClosest=function(b,c){Element.prototype.matches||(Element.prototype.matches=
Element.prototype.matchesSelector||Element.prototype.mozMatchesSelector||Element.prototype.msMatchesSelector||Element.prototype.oMatchesSelector||Element.prototype.webkitMatchesSelector||function(b){b=(this.document||this.ownerDocument).querySelectorAll(b);for(var c=b.length;0<=--c&&b.item(c)!==this;);return-1<c});for(;b&&b!==document;b=b.parentNode)if(b.matches(c))return b;return null};return this.zuix=this.zuix||{controller:l,load:q,unload:G,componentize:n,context:B,hook:function(b,c){I(b,c);return this},
$:g,field:m,TaskQueue:y,ZQuery:h,dumpCache:function(){console.log("ZUIX","Component Cache",w)},dumpContexts:function(){console.log("ZUIX","Loaded Component Instances",v)}}}(function(d,k){"function"===typeof define&&define.amd?define(["zuix"],function(){return d.zuix=k.call(d)}):"object"===typeof module&&module.exports?module.exports=k.call(d):d.zuix=k.call(d)})(this,Zuix);
