...
(d={},e=new B(d,w)):b.isNoU(d.contextId)?(!1===d&&(d={}),d.contextId="zuix-ctx-"+ ++E,e=z(d)):(e=k(d.contextId),null!==e?e.options(d):e=z(d));e.componentId!=a&&(e.componentId=a);var f=l(e.componentId);null!==f&&b.isNoU(e.controller())&&e.controller(f.controller);b.isFunction(d.ready)&&(e.ready=d.ready);b.isFunction(d.error)&&(e.error=d.error);if(b.isNoU(d.view)){if(null!==f?e.view(f.view):(f=c().find('[data-ui-view="'+e.componentId+'"]'),0<f.length()&&e.view(f.get(0))),b.isNoU(e.view()))return n.queue("html:"+
...
(new Date).getTime(),success:function(c){try{var e=c.indexOf(".load");1<e&&(c=c.substring(0,e-4));var f=c.indexOf(".controller");1<f&&(c=c.substring(f+11));a.controller(F(c))}catch(g){console.log(g,c,a);b.isFunction(a.error)&&a.error(a,g);return}u(a);d.end()},error:function(c){d.end();u(a);console.log(c,a);b.isFunction(a.error)&&a.error(a,c)}})}):u(a)}function u(a){if(!b.isNoU(a.view())){if(null===l(a.componentId)){var d=a.view()===a.container()?a.view().innerHTML:a.view().outerHTML,d=c.wrapElement("div",
d);y.push({componentId:a.componentId,view:d.innerHTML,controller:a.controller()})}b.isFunction(a.controller())&&(d=a._c=new G(a),b.isNoU(d.view())||d.view().setAttribute("data-ui-component",d.componentId),b.isFunction(d.create)&&d.create(),d.trigger("view:create"),a.updateModelView(),b.isFunction(d.resume)&&d.resume());b.isFunction(a.ready)&&a.ready(a)}}function F(a){var b=function(a){};"string"===typeof a&&(b=eval.call(this,a));return b}function w(c,d,e){b.isFunction(q[d])&&q[d].call(c,d,e);"view:process"==
d&&a(e)}function H(a,c){if(b.isNoU(c))return q[a];q[a]=c;return this}var B=e("./ComponentContext"),G=e("./ContextController"),n=new d(function(a,b,c){w(a,b,c)}),y=[],x=[],E=0,p=[],A=[],q=[],v=!1,D=!0;navigator&&navigator.userAgent&&(v=(new RegExp(/bot|googlebot|crawler|spider|robot|crawling/i)).test(navigator.userAgent));v&&console.log(navigator.userAgent,"is a bot, ignoring 'data-ui-lazyload' option.");return{controller:function(a){return a},load:f,unload:function(a){b.isNoU(a)||b.isNoU(a._c)||(b.isNoU(a._c.view())||
a._c.view().removeAttribute("data-ui-component"),b.isFunction(a._c.destroy)&&a._c.destroy())},componentize:a,context:k,hook:function(a,b){H(a,b);return this},$:c,field:function(a,b){return c(b).find('[data-ui-field="'+a+'"]').get(0)},TaskQueue:d,ZxQuery:c.ZxQuery,dumpCache:function(){console.log("ZUIX","Component Cache",y)},dumpContexts:function(){console.log("ZUIX","Loaded Component Instances",x)}}}},{"../helpers/TaskQueue":1,"../helpers/Util":2,"../helpers/ZxQuery":3,"./ComponentContext":5,"./ContextController":6}]},
{},[4])(4)});
