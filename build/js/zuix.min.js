...
throw{message:"Not attacched to a view yet.",source:this};};d.prototype.model=function(b){if(null==b)return this.context.model();this.context.model(b);return this};d.prototype.options=function(){return this.context.options()};d.prototype.trigger=function(b,c,a){null==this.context._eventMap[b]&&!0!==a&&this.addEvent(this.view(),b,null);!0===a?this.context.trigger(this.context,b,c):this.view().trigger(b,c);return this};d.prototype.expose=function(b,c){if("object"===typeof b){var a=this;k.each(b,function(c,
b){a.context[c]=b})}else this.context[b]=c;return this};d.prototype.loadCss=function(b){this.context.loadCss(b);return this};d.prototype.loadHtml=function(b){this.saveView();this.context.loadHtml(b);return this};d.prototype.log={};d.prototype.for=function(b){return this};p.exports=d},{"../helpers/ZxQuery":4}],8:[function(m,p,t){function d(){this._fieldCache=[];return this}function k(a,c,b){l.isNoU(b)&&(b=this);null==b._fieldCache&&(b._fieldCache={});var d=null;"undefined"===typeof b._fieldCache[a]?
(d=q(c).find('[data-ui-field="'+a+'"]'),null!=d&&(b._fieldCache[a]=d)):d=b._fieldCache[a];return d}function b(a){n.t("componentize:check","lock:request");if(A("zuix").requestLock(b)){n.t("componentize:begin","timer:task:start",a,w.length);var d=q(a).find("[data-ui-load]:not([data-ui-loaded=true]),[data-ui-include]:not([data-ui-loaded=true])"),d=Array.prototype.slice.call(d._selection);d.sort(function(a,b){var c=parseInt(a.getAttribute("data-ui-priority"));isNaN(c)&&(c=0);var r=parseInt(b.getAttribute("data-ui-priority"));
isNaN(r)&&(r=0);return c-r});n.t("componentize:count",d.length);q.each(d,function(a,r){this.visibility("hidden");var d=r.lazyContainer||q.getClosest(r,"[data-ui-lazyload=scroll]");r.lazyContainer=d;if(!(null!=d&&"force"==d.getAttribute("data-ui-lazyload")||g()&&"false"!=this.attr("data-ui-lazyload")))return c(r),!1;if(null!==d&&(-1==F.indexOf(d)&&(F.push(d),q(d).on("scroll",function(){b(d)})),!q.getPosition(r).visible))return-1==w.indexOf(r)&&(n.t("componentize:lazyload","queue:add",r),w.push(r)),
!0;n.t("componentize:lazyload","queue:load",r);c(r)});n.t("componentize:end","timer:task:end",a,B.length,x.length);A("zuix").releaseLock(b)}null!=d&&d.length>w.length&&A("zuix").lockLater(b,function(){b(a)},200)}function c(c){var b=q(c);if("true"===b.attr("data-ui-loaded")||0<b.parent("pre,code").length())n.w("Skipped",c);else{b.attr("data-ui-loaded","true");var d=b.attr("data-ui-options");l.isNoU(d)?d={}:(d=l.propertyFromPath(window,d),d=l.cloneObject(d)||{});l.isNoU(d.view)&&!b.isEmpty()?(d.view=
c,d.viewDeferred=!0):l.isNoU(d.view)&&l.isNoU(d.container)&&b.isEmpty()&&(d.container=c);var e=b.attr("data-ui-load");l.isNoU(e)&&(e=b.attr("data-ui-include"),b.attr("data-ui-component",e),l.isNoU(d.controller)&&(d.controller=function(){}));var f=b.attr("data-bind-model");!l.isNoU(f)&&0<f.length&&(d.model=l.propertyFromPath(window,f));f=b.attr("data-ui-context");l.isNoU(f)||(d.contextId=f);b=b.attr("data-ui-priority");l.isNoU(b)?d.priority=B.length:d.priority=b;a(e,d);d=w.indexOf(c);n.t("componentize:lazyload",
"queue:remove",d,c);-1<d&&w.splice(d,1)}}function a(a,b){var c=null;l.isNoU(b)?(b={},c=new N(b,e)):(b.componentId=a,l.isNoU(b.contextId)?(!1===b&&(b={}),b.contextId="zuix-ctx-"+ ++R,c=f(b)):(c=h(b.contextId),null!==c?c.options(b):c=f(b)));c.componentId!=a&&(c.componentId=a);l.isFunction(b.ready)&&(c.ready=b.ready);l.isFunction(b.error)&&(c.error=b.error);if(b.lazyLoad)return c;if(null==u[a])return u[a]=!0,v(c,b);var d=setInterval(function(){null==u[a]&&(u[a]=!0,clearInterval(d),v(c,b))},100);return c}
function v(a,b){var c=L(a.componentId);null!==c&&null==b.controller&&null==a.controller()&&(a.controller(c.controller),n.t("js:"+a.componentId,"component:cached:js"));if(l.isNoU(b.view)){if(null!==c&&null!=c.view&&(a.view(c.view),n.t("html:"+a.componentId,"component:cached:html"),null!=c.view&&l.isNoU(b.css)&&(b.css=!1,c.css_applied||(c.css_applied=!0,a.style(c.css),n.t("css:"+a.componentId,"component:cached:css")))),l.isNoU(a.view()))return A(a.componentId).queue("html:"+a.componentId,function(){u[a.componentId]=
this;a.loadHtml({caching:y,success:function(d){null==c&&(c=z(a));c.view=d;delete c.controller;!1!==b.css?(u[a.componentId].step("css:"+a.componentId),a.loadCss({caching:y,success:function(a){c.css=a},error:function(b){n.e(b,a)},then:function(){D(a,u[a.componentId])}})):D(a,u[a.componentId])},error:function(c){n.e(c,a);l.isFunction(b.error)&&a.error.call(a,c)}})},b.priority),a}else a.view(b.view);A(a.componentId).queue("js:"+a.componentId,function(){u[a.componentId]=this;D(a,u[a.componentId])},B.length);
return a}function f(a){a=new N(a,e);B.push(a);return a}function h(a){var b=null;a instanceof q.ZxQuery&&(a=a.get());q.each(B,function(c,d){if(a instanceof Element&&(d.view()===a||d.container()===a)||l.objectEquals(d.contextId,a))return b=d,!1});return b}function e(a,c,d){l.isFunction(G[c])&&G[c].call(a,d);"view:process"==c&&b(d)}function g(a){null!=a&&(O=!a);return!H&&!O}function K(a){null!=a&&(y=a);return y}function L(a){var b=null;q.each(x,function(c,d){if(l.objectEquals(d.componentId,a))return b=
d,!1});return b}function D(a,b){if("undefined"===typeof a.options().controller&&null===a.controller())if(n.d(a.componentId,"controller:load"),l.isNoU(b)||b.step("js:"+a.componentId),l.isFunction(I[a.componentId]))a.controller(I[a.componentId]),E(a,b);else{var c=function(b){q.ajax({url:a.componentId+".js"+(y?"":"?"+(new Date).getTime()),success:function(b){try{var c=b.indexOf("function"),d=b.indexOf(".load");1<d&&d<c&&(b=b.substring(0,d-4));var e=b.indexOf(".controller");1<e&&e<c&&(b=b.substring(e+
11));var f=b.indexOf("//<--controller");0<f&&(b=b.substring(0,f));b+='\n//# sourceURL="'+a.componentId+'.js"\n';a.controller(Q(b))}catch(g){n.e(Error(),g,b,a),l.isFunction(a.error)&&a.error.call(a,g)}},error:function(b){n.e(b,Error(),a);l.isFunction(a.error)&&a.error.call(a,b)},then:function(){E(a,b)}})};l.isNoU(b)?A(a.componentId).queue("js:"+a.componentId,function(){c(u[a.componentId]=this)},a.options().priority):c(b)}else E(a,b)}function z(a){var b=a.view().innerHTML,b=q.wrapElement("div",b),b=
{componentId:a.componentId,view:b.innerHTML,css:a._css,controller:a.controller()};x.push(b);n.t(a.componentId,"bundle:added");return b}function E(a,b){u[a.componentId]=null;if(l.isNoU(a.view()))n.e(a.componentId,"component:view:undefined");else{var c=L(a.componentId);a.options().viewDeferred||(null===c?c=z(a):null==c.controller?c.controller=a.controller():n.w(a.componentId,"component:deferred:load"));null!=b&&b.callback(function(){n.d(a.componentId,"controller:create:deferred");M(a._c)});n.d(a.componentId,
"component:initializing");if(l.isFunction(a.controller())){var d=a._c=new S(a);d.log=m("../helpers/Logger")(a.contextId);"function"===typeof d.init&&d.init();if(!l.isNoU(d.view()))if(d.view().attr("data-ui-component",a.componentId),l.isNoU(a.model())&&!l.isNoU(a.view())&&a.viewToModel(),d.trigger("view:apply"),a.options().viewDeferred){a.options().viewDeferred=!1;d.saveView();null===c&&(c={componentId:a.componentId,controller:a.controller()},x.push(c),n.t(a.componentId,"bundle:added"),n.d(a.componentId,
"component:deferred:load"));var e=-1;!1!==a.options().css&&(null==c.css?(-1==e&&(e=0),e++,a.loadCss({caching:y,success:function(b){null==c.css&&(c.css=b);n.d(a.componentId,"component:deferred:css",e)},then:function(){0===--e&&null!=b&&b.end()}})):a.style(c.css));!1!==a.options().html&&(null==c.view?(-1==e&&(e=0),e++,a.loadHtml({caching:y,success:function(b){null==c.view&&(c.view=b);n.d(a.componentId,"component:deferred:html",e)},then:function(){0===--e&&null!=b&&b.end()}})):a.view(c.view));-1==e&&
null!=b&&b.end()}else null!=b&&b.end();null==b&&(n.d(a.componentId,"controller:create"),M(d))}else n.w(a.componentId,"component:controller:undefined")}}function M(a){a.field=function(b){b=k(b,a.view(),a);b.on=function(b,c,d,e){if("string"===typeof c){var f=c;c=function(){a.trigger(f,d,e)}}q.ZxQuery.prototype.on.call(this,b,c)};return b};l.isFunction(a.create)&&a.create();a.trigger("view:create");a.trigger("component:ready",a.view(),!0);l.isFunction(a.context.ready)&&a.context.ready.call(a.context);
a.view().css("visibility","");n.i(a.context.componentId,"component:loaded",a.context.contextId)}function Q(a){var b=function(a){};if("string"===typeof a)try{b=eval.call(this,a)}catch(c){n.e(this,c,a)}return b}var n=m("../helpers/Logger")("Zuix.js"),l=m("../helpers/Util"),q=m("../helpers/ZxQuery"),P=m("../helpers/TaskQueue"),N=m("./ComponentContext"),S=m("./ContextController"),x=[],R=0,B=[],u=[],G=[],I={},w=[],F=[],J=[],A=function(a){l.isNoU(J[a])&&(J[a]=new P(function(a,b,c){e(a,b,c)}));return J[a]},
H=!1,O=!1,y=!0;navigator&&navigator.userAgent&&(H=(new RegExp(/bot|googlebot|crawler|spider|robot|crawling/i)).test(navigator.userAgent));H&&n.d(navigator.userAgent,"is a bot, ignoring 'data-ui-lazyload' option.");d.prototype.controller=function(a){"function"!==typeof a["for"]&&(a["for"]=function(b){return I[b]=a});return a};d.prototype.field=k;d.prototype.componentize=function(a){b(a);return this};d.prototype.load=a;d.prototype.unload=function(a){l.isNoU(a)||l.isNoU(a._c)||(l.isNoU(a._c.view())||
a._c.view().attr("data-ui-component",null),l.isFunction(a._c.destroy)&&a._c.destroy());return this};d.prototype.context=h;d.prototype.createComponent=function(b,c){null==c&&(c={});c.container=document.createElement("div");return a(b,c)};d.prototype.trigger=function(a,b,c){e(a,b,c);return this};d.prototype.hook=function(a,b){l.isNoU(b)||(G[a]=b);return this};d.prototype.lazyLoad=function(a){if(null!=a)g(a);else return g();return this};d.prototype.httpCaching=function(a){if(null!=a)K(a);else return K();
return this};d.prototype.bundle=function(a,c){if(l.isNoU(a))return x;if(a&&"boolean"===typeof a){n.t("bundle:start");var d=g();g(!1);b();if("function"===typeof c){var e=function(a){0<w.length?(n.t("bundle:wait"),setTimeout(function(){a(a)},1E3)):(n.t("bundle:end"),g(d),c())};e(e)}}else{for(e=0;e<a.length;e++)a[e].css_applied&&delete a[e].css_applied;x=a}return this};d.prototype.$=q;d.prototype.TaskQueue=P;d.prototype.ZxQuery=q.ZxQuery;d.prototype.dumpCache=function(){return x};d.prototype.dumpContexts=
function(){return B};d.prototype.dumpLazyLoaders=function(){return F};p.exports=function(a){var b=new d;"loading"!=document.readyState?b.componentize():document.addEventListener("DOMContentLoaded",function(){b.componentize()});n.monitor(function(a,c){l.isFunction(b.monitor)&&b.monitor(a,Array.prototype.slice.call(c))});return b}},{"../helpers/Logger":1,"../helpers/TaskQueue":2,"../helpers/Util":3,"../helpers/ZxQuery":4,"./ComponentContext":6,"./ContextController":7}]},{},[5])(5)});
