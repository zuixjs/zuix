...
f.clientLeft,c+=f.offsetTop-f.scrollTop+f.clientTop;f=f.offsetParent}d={x:d,y:c,rect:e};c=b.offsetParent;if(null!=c){var h;c===document.body?(l=document.documentElement.offsetWidth,h=document.documentElement.offsetHeight):(l=c.offsetWidth,h=c.offsetHeight);e=!1;if(null===b.offsetParent)return!1;null==a&&(a=0);for(var e=l,f=h,m=b.getBoundingClientRect(),k=b.offsetParent;null!==k&&k!==c;)var n=k.getBoundingClientRect(),m={left:m.left+n.left,top:m.top+n.top,right:m.right+n.left,bottom:m.bottom+n.top,
width:m.width,height:m.height},k=k.offsetParent;e=!(m.left>e-a||m.right<0+a||m.top>f-a||m.bottom<0+a);d.frame={dx:(m.left+m.width/2-0)/l,dy:(m.top+m.height/2-0)/h};d.visible=e;b=g(b);!e&&b.hasClass("--ui--visible")?(b.removeClass("--ui--visible"),d.event="exit"):e?e&&(b.hasClass("--ui--visible")?d.event="scroll":(d.event="enter",b.addClass("--ui--visible"))):d.event="off-scroll"}return d};g.ZxQuery=h;Element.prototype.matches||(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.mozMatchesSelector||
...
a.success.call(l,b)},error:function(b){k.e(b,l);c.isFunction(a.error)&&a.error.call(l,b)},then:function(){c.isFunction(a.then)&&a.then.call(l)}});return this};a.prototype.loadHtml=function(a,m){var l=this,g=l.componentId;c.isNoU(a)&&(a={});c.isNoU(a.caching)||(m=a.caching);c.isNoU(a.path)||(g=a.path);var b=e().find("["+f.dataUiView+'="'+g+'"]:not(['+f.dataUiComponent+'*=""])');0<b.length()?(g=b.get(0),l.view()===g||null!=l.container()&&l.container().contains(g)?l.view(g):l.view(g.outerHTML),c.isFunction(a.success)&&
a.success.call(l,g.outerHTML),c.isFunction(a.then)&&a.then.call(l)):(b=c.isNoU(a.cext)?".html":a.cext,g==l.componentId&&(g+=b+(m?"":"?"+(new Date).getTime())),e.ajax({url:h.getResourcePath(g),success:function(b){l.view(b);c.isFunction(a.success)&&a.success.call(l,b)},error:function(b){k.e(b,l);c.isFunction(a.error)&&a.error.call(l,b)},then:function(){c.isFunction(a.then)&&a.then.call(l)}}));return this};a.prototype.viewToModel=function(){k.t(this.componentId,"view:model","timer:vm:start");var a=this;
this._model={};e(this._view).find("["+f.dataUiField+"]").each(function(e,h){if(0<this.parent("pre,code").length())return!0;var g=this.attr(f.dataUiField),b=!c.isNoU(h.innerHTML)&&c.isIE()?h.cloneNode(!0):h;if(0<g.indexOf(".")){for(var g=g.split("."),k=a._model,n=0;n<g.length-1;n++)"undefined"===typeof k[g[n]]&&(k[g[n]]={}),k=k[g[n]];k[g[g.length-1]]=b}else a._model[g]=b});k.t(this.componentId,"view:model","timer:vm:stop");return this};a.prototype.modelToView=function(){k.t(this.componentId,"model:view",
"timer:mv:start");if(null!=this._view&&null!=this._model){var a=this;e(this._view).find("["+f.dataUiField+"]").each(function(h,l){if(0<this.parent("pre,code").length())return!0;var g=this.attr(f.dataBindTo);null==g&&(g=this.attr(f.dataUiField));if("function"===typeof a._model)a._model.call(e(a._view),this,g);else{var b=c.propertyFromPath(a._model,g);if("function"===typeof b)b.call(e(a._view),this,g);else if(null!=b)switch(l.tagName.toLowerCase()){case "img":l.src=c.isNoU(b.src)?c.isNoU(b.innerHTML)?
...
f.dataUiField&&("+"===k.value[0]&&l.hasAttribute(k.name)&&(k.value=l.getAttribute(k.name)+" "+k.value.substring(1)),l.setAttribute(k.name,k.value))}}}})}k.t(this.componentId,"model:view","timer:mv:stop");return this};r.exports=a},{"../helpers/Logger":2,"../helpers/Util":4,"../helpers/ZxQuery":5,"./OptionAttributes":11}],9:[function(n,r,y){function a(){}function k(a,b){null!=a&&(H=!a);null!=b&&(J=b);return!C&&!H}function f(a){null==a&&(a=document);E.indexOf(a)||E.push(a)}function e(a){for(var b=0;b<
A.length;b++){var c=A[b];if(c.element===a)return c.waiting}return null}function c(a){null==a&&0<E.length&&(a=E.unshift());a instanceof u.ZxQuery&&(a=a.get());var b=e(a),b=u(a).find("["+t.dataUiLoad+"]:not(["+t.dataUiLoaded+"=true]),["+t.dataUiInclude+"]:not(["+t.dataUiLoaded+"=true])"),b=Array.prototype.slice.call(b._selection);A.push({element:a,waiting:b});a=[];for(var c=0;c<b.length;c++){var d=b[c],z=parseInt(d.getAttribute(t.dataUiPriority));isNaN(z)&&(z=0);for(var f=0,F=d.parentNode,h=!1;null!=
F&&F!==document;){f++;if(null!=F.getAttribute(t.dataUiView)){h=!0;break}F=F.parentNode}h||(F=new B,F.element=d,F.priority=z+1E3*f,a.push(F))}for(c=b=0;c<a.length;c++){d=!1;for(z=0;z<x.length;z++)if(a[c].element===x[z].element){d=!0;break}d||(d=a[c].element,z=d.getAttribute(t.dataUiOptions),g(d,z),x.push(a[c]),b++)}q.t("componentize:count",x.length,b);(0===b||0===E.length&&0===x.length)&&D.trigger(this,"componentize:end")}function h(){x.sort(function(a,b){return a.priority-b.priority});for(var a=null,
b=0<x.length?x.shift():null;null!=b&&null!=b.element;){var c=O(b.element);k()&&c?(b.lazy=!0,b.visible=u.getPosition(b.element,J).visible):(b.lazy=!1,b.visible=!0);if(null!=b&&null!=b.element&&b.visible){a={item:b,cancelable:b.lazy};break}if(0<x.length)b=x.shift();else break}return a}function d(a){c(a);a=h();null!=a&&K.append([a])}function m(a){var b=u(a);if("true"===b.attr(t.dataUiLoaded)||0<b.parent("pre,code").length())return!1;b.attr(t.dataUiLoaded,"true");var c=b.attr(t.dataUiOptions);p.isNoU(c)?
c={}:(c=p.propertyFromPath(window,c),c=p.cloneObject(c)||{});var e=b.attr(t.dataUiContext);if(!p.isNoU(e)){var z=D.context(e);null!==z&&(c=z.options());c.contextId=e}p.isNoU(c.view)&&!b.isEmpty()?(c.view=a,c.viewDeferred=!0):p.isNoU(c.view)&&p.isNoU(c.container)&&b.isEmpty()&&(c.container=a);e=b.attr(t.dataUiLoad);if(p.isNoU(e))if(e=b.attr(t.dataUiInclude),null!=e)e=l(e),b.attr(t.dataUiInclude,e),b.attr(t.dataUiComponent,e),p.isNoU(c.controller)&&(c.controller=function(){});else return!1;else e=l(e),
b.attr(t.dataUiLoad,e);z=b.attr(t.dataBindModel);!p.isNoU(z)&&0<z.length&&(c.model=p.propertyFromPath(window,z));b=b.attr(t.dataUiPriority);p.isNoU(b)||(c.priority=parseInt(b));u(a).one("component:ready",function(){f(a);d(a)});D.load(e,c);return!0}function l(a){var b=D.store("config"),b=null!=b&&null!=b.libraryPath?b.libraryPath:"https://genielabs.github.io/zkit/lib";a.startsWith("@lib/")&&(a=b+a.substring(4));return a}function g(a,b){null==a||p.isNoU(b)||("string"===typeof b&&(b=p.propertyFromPath(window,
