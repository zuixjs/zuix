...
return!0}function B(b){var a=E.store("config");null!=a&&null!=a[location.host]&&(a=a[location.host]);a=null!=a&&null!=a.libraryPath?a.libraryPath:"https://genielabs.github.io/zkit/lib/";b.startsWith("@lib/")&&(b=a+b.substring(5));return b}function z(a,b){"string"===typeof b&&(b=p.propertyFromPath(window,b));null!=a&&null!=b&&(null!=b.lazyLoad&&a.setAttribute(t.dataUiLazyload,b.lazyLoad.toString().toLowerCase()),null!=b.contextId&&a.setAttribute(t.dataUiContext,b.contextId.toString().toLowerCase()),
null!=b.componentId&&a.setAttribute(t.dataUiLoad,b.componentId.toString().toLowerCase()))}function k(b){for(let a=0;a<N.length;a++){const c=N[a];if(c.element===b)return c}return null}function c(a){a={element:a};N.push(a);return a}function C(a){for(let b=0;b<v.length;b++){const c=v[b];if(c.element===a)return c}return null}function M(a){a={element:a};v.push(a);return a}function O(a){if("false"===a.getAttribute(t.dataUiLazyload))return!1;let e=k(a);if(null==e){const d=u.getClosest(a.parentNode,"["+t.dataUiLazyload+
