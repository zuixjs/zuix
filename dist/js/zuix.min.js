...
typeof d,d),Error("ZxQuery cannot wrap object of this type.");return this}function t(d){return new a(d)}const v=m("./Logger")("TaskQueue.js"),u=m("./Util.js");let e=u.hasPassiveEvents();const k=[];a.prototype.length=function(){return this._selection.length};a.prototype.parent=function(d){return u.isNoU(d)?new a(this._selection[0].parentNode):new a(l.getClosest(this._selection[0],d))};a.prototype.children=function(d){return u.isNoU(d)?new a(this._selection[0].children):new a(this._selection[0].querySelectorAll(d))};
...
t.each=function(d,a){const b=null==d?0:Object.keys(d).length;if(0<b){let e=0;for(let c in d)if(d.hasOwnProperty(c)){let f=d[c];f instanceof Element&&(f=l(f));if(!1===a.call(f,c,d[c],f))break;e++;if(e>=b)break}}return this};t.ajax=function(d){let a;a=u.isNoU(d)||u.isNoU(d.url)?d:d.url;const b=new XMLHttpRequest;b.onload=function(){200===b.status?u.isFunction(d.success)&&d.success(b.responseText):u.isFunction(d.error)&&d.error(b,b.statusText,b.status);u.isFunction(d.then)&&d.then(b)};b.onerror=function(a,
...
if(null!=d)for(let e=0;e<d.length;e++)try{const c=d[e].rules||d[e].cssRules;if(null!=c)for(let d=0;d<c.length;d++)if(c[d].selectorText===b){a=!0;break}}catch(p){if("SecurityError"!==p.name&&"InvalidAccessError"!==p.name)throw p;}});return a};t.wrapElement=function(d,a){d=document.createElement(d);"string"===typeof a?d.innerHTML=a:d.appendChild(a);return d};t.wrapCss=function(d,a,b){const e=/(([a-zA-Z0-9\240-\377=:-_\n,.@]+.*){([^{}]|((.*){([^}]+)[}]))*})/g;let c="",f;a=a.replace(/\/\*[\s\S]*?\*\/|([^:]|^)\/\/.*$/g,
"");do if((f=e.exec(a))&&1<f.length){var k=f[2];if(null!=k&&0<k.length){k=k.replace(/\n/g,"");const a=k.split(",");let e=!1;l.each(a,function(f,k){"."===k.trim()||":host"===k.trim()?c+="\n[z-component]"+d+" ":"@"===k.trim()[0]?(c+=k+" ",k.trim().toLowerCase().startsWith("@media")&&(e=!0)):c=b?c+("\n"+k.trim()+d+" "):c+("\n[z-component]"+d+"\n"+k.trim()+" ");f<a.length-1&&(c+=", ")});e?(k=l.wrapCss(d,f[1].substring(f[2].length).replace(/^{([^\0]*?)}$/,"$1"),b),c+="{\n  "+k+"\n}"):c+=f[1].substring(f[2].length)+
"\n"}else v.w("z$.wrapCss was unable to parse rule.",k,f)}while(f);""!==c&&(a=c);return a};t.appendCss=function(d,a,b){const e=document.head||document.getElementsByTagName("head")[0];let c=null;u.isNoU(a)?(a=document.getElementById(b),null!=a&&e.removeChild(a)):e.removeChild(a);"string"===typeof d?(c=document.createElement("style"),c.type="text/css",c.id=b,c.styleSheet?c.styleSheet.cssText=d:c.appendChild(document.createTextNode(d))):d instanceof Element&&(c=d);u.isNoU(c)||e.appendChild(c);return c};
t.replaceCssVars=function(d,a){const b=new RegExp(/\B\$var\[(.*[^\[\]])]/g);let e="",c=0,f=0,k;for(;k=b.exec(d);){let b=k[0];if(1<k.length){var l=k[1];let d=a;if(0<l.indexOf(".")){l=l.split(".");for(let a=0;a<l.length-1&&(d=d[l[a]],"undefined"!==typeof d);a++);"undefined"!==typeof d&&(b=d[l[l.length-1]],c++)}else"undefined"!==typeof d[l]&&(b=d[l],c++)}e+=d.substr(f,k.index-f)+b;f=k.index+k[0].length}0<c&&(d=e+=d.substr(f));return d};t.replaceBraces=function(d,a){const b=new RegExp(/{?{.*?}?}/g);let e=
"",c=0,f=0;for(var k;k=b.exec(d);){if("string"===typeof k[0]&&(0===k[0].trim().length||0<=k[0].indexOf("\n"))){k=d.substr(f,k.index-f)+k[0];e+=k;f+=k.length;continue}let b=k[0];if("function"===typeof a){const d=a(k[0]);u.isNoU(d)||(b=d,c++)}e+=d.substr(f,k.index-f)+b;f=k.index+k[0].length}return 0<c?e+=d.substr(f):null};t.getClosest=function(d,a){for(d=d.parentNode;d&&d!==document;d=d.parentNode)if(d.matches(a))return d;return null};t.getPosition=function(d,a){var b;{var e=b=0,c=d.getBoundingClientRect();
let a=d;for(;a;){if("body"===a.tagName.toLowerCase()){const d=a.scrollTop||document.documentElement.scrollTop;b+=a.offsetLeft-(a.scrollLeft||document.documentElement.scrollLeft)+a.clientLeft;e+=a.offsetTop-d+a.clientTop}else b+=a.offsetLeft-a.scrollLeft+a.clientLeft,e+=a.offsetTop-a.scrollTop+a.clientTop;a=a.offsetParent}b={x:b,y:e,rect:c}}b.visible=!1;c=d.offsetParent;if(null!=c){if(c!==document.body){for(e=c.offsetParent;null!=e&&null!==e.offsetParent&&e.offsetHeight===e.scrollHeight;)e=e.offsetParent;
null!=e&&(c=e)}e=c.getBoundingClientRect();c===document.body&&(e={x:e.x,y:e.y,width:document.documentElement.offsetWidth||document.documentElement.clientWidth,height:document.documentElement.offsetHeight||document.documentElement.clientHeight,top:0,left:0,right:document.documentElement.clientWidth||document.documentElement.offsetWidth,bottom:document.documentElement.clientHeight||document.documentElement.offsetHeight});null==a&&(a=0);c=d.getBoundingClientRect();a=!(c.left-1>e.right-a||c.right+1<e.left+
a||c.top-1>e.bottom-a||c.bottom+1<e.top+a);b.visible=a;b.frame={dx:(c.left+c.width/2-e.left)/e.width,dy:(c.top+c.height/2-e.top)/e.height};d=l(d);!a&&d.hasClass("--ui--visible")?(d.removeClass("--ui--visible"),b.event="exit"):a?a&&(d.hasClass("--ui--visible")?b.event="scroll":(b.event="enter",d.addClass("--ui--visible"))):b.event="off-scroll"}return b};t.prototype.ZxQuery=a;Element.prototype.matches||(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.mozMatchesSelector||
Element.prototype.msMatchesSelector||Element.prototype.oMatchesSelector||Element.prototype.webkitMatchesSelector||function(d){d=(this.document||this.ownerDocument).querySelectorAll(d);let a=d.length;for(;0<=--a&&d.item(a)!==this;);return-1<a});(function(){function d(d,a){a=a||{bubbles:!1,cancelable:!1,detail:void 0};const b=document.createEvent("CustomEvent");b.initCustomEvent(d,a.bubbles,a.cancelable,a.detail);return b}if("function"===typeof window.CustomEvent)return!1;d.prototype=window.Event.prototype;
window.CustomEvent=d})();String.prototype.hashCode=function(){let a=0;if(0===this.length)return a;for(let d=0;d<this.length;d++){let b=this.charCodeAt(d);a=(a<<5)-a+b;a|=0}return a};String.prototype.startsWith||(String.prototype.startsWith=function(a,b){return this.substr(!b||0>b?0:+b,a.length)===a});q.exports=l},{"./Logger":2,"./Util.js":4}],6:[function(m,q,w){m=m("./zuix/Zuix.js");"object"===typeof q&&q.exports?q.exports=m.call(this):this.zuix=m.call(this)},{"./zuix/Zuix.js":16}],7:[function(m,
q,w){function c(){this.observableList=[]}function g(a){let b="";for(;a&&a.__path__;){const c=a;a=a.__parents__[0];b=null!=a&&null!=a.__path__?"['"+c.__path__+"']."+b:c.__path__+(b.startsWith("[")?"":".")+b}return b}function f(a){const b=[];a.__parents__.forEach(function(a){b.push(...f(a))});b.push(...a.__listeners__);return b}function b(a){f(a).forEach(function(b){a.unsubscribe(b)})}m("./ObservableListener");const h=m("./ObservableObject");c.prototype.observable=function(a){let c;const m=this.observableList.filter(function(b){return a===
b.proxy||a===b.target});1===m.length&&(c=m[0]);null==c&&(c=new h(this,a,{context:null,get:function(a,b){if("observableTarget"===b)return a;let e=a[b];if("undefined"!==typeof e){var c=[],d=this.context.observable(a);if("object"===typeof e){const a=this.context.observable(e);-1===a.__parents__.indexOf(d)&&(a.__parents__.push(d),a.__path__=b);c.push(...f(a));e=a.proxy}else c.push(...f(d));var h=g(d)+b;c.forEach(function(d){d.get(a,b,e,h)});return e}},set:function(a,e,c){let k=JSON.parse(JSON.stringify(a));
var d=a[e];"object"===typeof d&&b(this.context.observable(d));a[e]=c;d=this.context.observable(a);const h=g(d)+e;f(d).forEach(function(d){d.set(a,e,c,h,k)});return!0},deleteProperty:function(a,e){let c=a[e];"object"===typeof c&&b(this.context.observable(c));return delete a[e]}}));return c};q.exports=c},{"./ObservableListener":8,"./ObservableObject":9}],8:[function(m,q,w){function c(){}c.prototype.get=function(c,f,b,h){};c.prototype.set=function(c,f,b,h,a){};q.export=c},{}],9:[function(m,q,w){function c(c,
f,b){Object.assign(b,{context:c});Object.assign(this,Proxy.revocable(f,b));this.handler=b;this.handler.context.observableList=this.handler.context.observableList||[];this.handler.context.observableList.push(this);this.target=f;this.__parents__=[];this.__listeners__=[]}m("./ObservableListener");c.prototype.subscribe=function(c){const f=this;this.handler.context.observableList.forEach(function(b){if(b!==f&&-1!==b.__listeners__.indexOf(c))throw Error("Listener already registered.");});this.__listeners__.push(c);
return this};c.prototype.unsubscribe=function(c){c=this.__listeners__.indexOf(c);-1!==c&&this.__listeners__.splice(c,1);if(0===this.__listeners__.length){this.revoke();const c=this;this.handler.context.observableList=this.handler.context.observableList.filter(function(b){if(b===c)return!1;const f=b.__parents__.indexOf(c);return-1!==f&&(b.__parents__.splice(f,1),0===b.__parents__.length&&0===b.__listeners__.length)?(b.unsubscribe(null),!1):!0})}return this};q.exports=c},{"./ObservableListener":8}],
10:[function(m,q,w){q.exports=function(c){return null}},{}],11:[function(m,q,w){function c(e,c){c=c.observableTarget||c;switch(e.tagName.toLowerCase()){case "img":e.src=a.isNoU(c.src)?a.isNoU(c.innerHTML)?c:c.innerHTML:c.src;c.alt&&(e.alt=c.alt);break;case "a":e.href=a.isNoU(c.href)?a.isNoU(c.innerHTML)?c:c.innerHTML:c.getAttribute("href");c.title&&(e.title=c.title);a.isNoU(c.href)||a.isNoU(c.innerHTML)||""===c.innerHTML.trim()||(e.innerHTML=c.innerHTML);break;case "input":e.value=a.isNoU(c.value)?
a.isNoU(c.innerHTML)?c:c.innerHTML:c.value;break;default:if(e.innerHTML=a.isNoU(c.innerHTML)?c:c.innerHTML,null!=c.attributes)for(let f=0;f<c.attributes.length;f++){const d=c.attributes[f];d.specified&&d.name!==b.dataUiField&&("+"===d.value[0]&&e.hasAttribute(d.name)&&(d.value=e.getAttribute(d.name)+" "+d.value.substring(1)),a.dom.setAttribute(e,d.name,d.value))}}}function g(e,f,l){v=e;this._options=null;this.contextId=null==f||null==f.contextId?null:f.contextId;this.componentId=null;this.trigger=
function(a,b,c){"function"===typeof l&&l(a,b,c)};this.behavior=this._controller=this._style=this._css=this._view=this._model=this._container=null;this._eventMap=[];this._behaviorMap=[];this._c=null;this._modelListener=Object.assign({context:null,get:function(a,b,c,e){},set:function(d,e,f,k,l){d instanceof Element&&(k=k.split(".")[0],f=d);const g=h(this.context.view());if(g.get()){let h=g.find(a.dom.queryAttribute(b.dataBindTo,k));null==h.get()&&(h=g.find(a.dom.queryAttribute(b.dataUiField,k)));h.get()&&
c(h.get(),f);this.context._c&&"function"===typeof this.context._c.update&&this.context._c.update(d,e,f,k,l)}}},{context:this});this._viewObserver=new t(this);this.options(f);return this}const f=m("../helpers/Logger")("ComponentContext.js"),b=m("./OptionAttributes"),h=m("../helpers/ZxQuery"),a=m("../helpers/Util"),t=m("./ViewObserver");let v=null;const u=[];g.prototype.dispose=function(){this._viewObserver.stop();a.isNoU(this._c)||(a.isNoU(this._c.view())||(this._c.view().attr(b.dataUiComponent,null),
this._c.view().reset(),a.isNoU(this._c._fieldCache)||h.each(this._c._fieldCache,function(a,b){b.reset()})),a.isFunction(this._c.destroy)&&this._c.destroy.call(this,this));this.model(null);this._c.view().detach();const c=this._container;null!=c&&null!=c.parentNode&&c.parentNode.removeChild(c)};g.prototype.container=function(a){if(null==a)return this._container;a instanceof h.ZxQuery&&(a=a.get());this._container=a;return this};g.prototype.view=function(c){if("undefined"===typeof c)return this._view;
if(null===c)throw Error("View cannot be set to null.");c instanceof h.ZxQuery&&(c=c.get());if(c===this._view)return this;this._viewObserver.stop();const e=this.getCssId();if(null!=this._view){var l="*"+a.dom.cssNot(b.dataUiLoad).getAll()+a.dom.cssNot(b.dataUiInclude).getAll();h(this._view).attr(e,null).find(l).each(function(a,b){this.attr(e,null)})}f.t(this.componentId,"view:attach","timer:view:start");"string"===typeof c?(c={content:c},this.trigger(this,"html:parse",c),c=c.content,l=h.wrapElement("div",
c),null!=l.firstElementChild&&(null!=a.dom.getAttribute(l.firstElementChild,b.dataUiView)?1===l.children.length&&(c=l.firstElementChild.innerHTML):c=l.innerHTML),null!=this._container?(this._view=this._container,this._view.innerHTML+=c):null!=this._view?this._view.innerHTML=c:this._view=l,h(this._view).find("script").each(function(a,c){"true"!==this.attr(b.zuixLoaded)&&(this.attr(b.zuixLoaded,"true"),eval.call(window,c.innerHTML))}),this.trigger(this,"view:process",h(this._view))):null!=this._container?
(this._view=h.wrapElement("div",c.outerHTML).firstElementChild,a.dom.setAttribute(this._view,b.dataUiView,null),this._container.appendChild(this._view),this._view=this._container):this._view=c;c=h(this._view);c.find(a.dom.queryAttribute(b.dataUiLoad)).each(function(a,c){this.attr(b.dataUiLoaded,"false")});!1!==this._options.css&&(c.attr(e,""),null!=this._container||null!=this._style?(l="*"+a.dom.cssNot(b.dataUiLoad).getAll()+a.dom.cssNot(b.dataUiInclude).getAll(),c.find(l).each(function(a,b){this.attr(e,
"")}),this._viewObserver.start(),c.attr("_ctrl_",null)):c.attr("_ctrl_",""));this.modelToView();f.t(this.componentId,"view:attach","timer:view:stop");return this};g.prototype.style=function(a){if("undefined"===typeof a)return this._style;f.t(this.componentId,"view:style","timer:view:start");if(null==a||a instanceof Element)this._css=a instanceof Element?a.innerText:a,this._style=h.appendCss(a,this._style,this.componentId);else if("string"===typeof a){this._css=a;a={content:a};this.trigger(this,"css:parse",
a);a=a.content;let b="";!0===this.options().resetCss&&(b="p,ol,ul,li,dl,dt,dd,blockquote,figure,fieldset,legend,textarea,pre,iframe,hr,h1,h2,h3,h4,h5,h6{margin:0;padding:0}h1,h2,h3,h4,h5,h6{font-size:100%;font-weight:normal}ul{list-style:none}button,input,select,textarea{margin:0}html{box-sizing:border-box}*,*:before,*:after{box-sizing:inherit}img,video{height:auto;max-width:100%}iframe{border:0}table{border-collapse:collapse;border-spacing:0}td,th{padding:0;text-align:left}");const c="["+this.getCssId()+
...
12:[function(m,q,w){function c(){}function g(a,b){null!=a&&(K=!a);null!=b&&(L=b);return!A&&!K}function f(a){null==a&&(a=document);F.indexOf(a)||F.push(a)}function b(a){for(let b=0;b<H.length;b++){const c=H[b];if(c.element===a)return c.waiting}return null}function h(a){null==a&&0<F.length&&(a=F.unshift());a instanceof D.ZxQuery&&(a=a.get());b(a);var c=p.dom.queryAttribute(n.dataUiLoad,null,p.dom.cssNot(n.dataUiLoaded))+","+p.dom.queryAttribute(n.dataUiInclude,null,p.dom.cssNot(n.dataUiLoaded));c=D(a).find(c);
c=Array.prototype.slice.call(c._selection);H.push({element:a,waiting:c});a=[];for(var d=0;d<c.length;d++){var f=c[d],z=+p.dom.getAttribute(f,n.dataUiPriority);isNaN(z)&&(z=0);let b=0;var G=f.parentNode;let e=!1;for(;null!=G&&G!==document;){b++;if(null!=p.dom.getAttribute(G,n.dataUiView)){e=!0;break}G=G.parentNode}e||(G=new M,G.element=f,G.priority=z+1E3*b,a.push(G))}c=0;for(d=0;d<a.length;d++){f=!1;for(z=0;z<y.length;z++)if(a[d].element===y[z].element){f=!0;break}f||(f=a[d].element,z=p.dom.getAttribute(f,
n.dataUiOptions),e(f,z),y.push(a[d]),c++)}r.t("componentize:count",y.length,c);(0===c||0===F.length&&0===y.length)&&C.trigger(this,"componentize:end")}function a(){y.sort(function(a,b){return a.priority-b.priority});let a=null,b=0<y.length?y.shift():null;for(;null!=b&&null!=b.element;){const c=O(b.element);g()&&c?(b.lazy=!0,b.visible=D.getPosition(b.element,L).visible):(b.lazy=!1,b.visible=!0);if(null!=b.element&&b.visible){a={item:b,cancelable:b.lazy};break}if(0<y.length)b=y.shift();else break}return a}
function t(b){h(b);b=a();null!=b&&N.append([b])}function v(a){var b=D(a);if(null!=b.attr(n.dataUiLoaded)||0<b.parent("pre,code").length())return!1;b.attr(n.dataUiLoaded,"true");let c=b.attr(n.dataUiOptions);p.isNoU(c)?c={}:(c=p.propertyFromPath(window,c),c=p.cloneObject(c)||{});var d=b.attr(n.dataUiContext);if(!p.isNoU(d)){var z=C.context(d);null!==z&&(c=z.options());c.contextId=d}p.isNoU(c.view)&&!b.isEmpty()?(c.view=a,c.viewDeferred=!0):p.isNoU(c.view)&&p.isNoU(c.container)&&b.isEmpty()&&(c.container=
a);d=b.attr(n.dataUiLoad);if(p.isNoU(d))if(d=b.attr(n.dataUiInclude),null!=d)d=u(d),b.attr(n.dataUiInclude,d),b.attr(n.dataUiComponent,""),p.isNoU(c.controller)&&(c.controller=function(){});else return!1;else d=u(d),b.attr(n.dataUiLoad,d);z=b.attr(n.dataBindModel);!p.isNoU(z)&&0<z.length&&(c.model=p.propertyFromPath(window,z));b=b.attr(n.dataUiPriority);p.isNoU(b)||(c.priority=+b);D(a).one("component:ready",function(){f(a);t(a)});C.load(d,c);return!0}function u(a){if("@"===a[0]){let b=C.store("config"),
c="https://zuixjs.github.io/zkit/lib/";null!=b&&null!=b[location.host]&&(b=b[location.host]);if(null!=b)switch(typeof b.libraryPath){case "object":D.each(b.libraryPath,function(b,d){return a.startsWith(b+"/")?(c=d,!1):!0});break;case "string":c=b.libraryPath}a=c+a.substring(a.indexOf("/")+1)}return a}function e(a,b){"string"===typeof b&&(b=p.propertyFromPath(window,b));null!=a&&null!=b&&(null!=b.lazyLoad&&p.dom.setAttribute(a,n.dataUiLazyload,b.lazyLoad.toString().toLowerCase()),null!=b.contextId&&
p.dom.setAttribute(a,n.dataUiContext,b.contextId.toString().toLowerCase()),null!=b.componentId&&p.dom.setAttribute(a,n.dataUiLoad,b.componentId.toString().toLowerCase()))}function k(a){for(let b=0;b<x.length;b++){const c=x[b];if(c.element===a)return c}return null}function l(a){a={element:a};x.push(a);return a}function d(a){for(let b=0;b<B.length;b++){const c=B[b];if(c.element===a)return c}return null}function E(a){a={element:a};B.push(a);return a}function O(a){if("false"===p.dom.getAttribute(a,n.dataUiLazyload))return!1;
let b=k(a);if(null==b){var c=p.dom.queryAttribute(n.dataUiLazyload,"scroll")+","+p.dom.queryAttribute(n.dataUiLazyload,"true");c=D.getClosest(a.parentNode,c);if(null!=c)return b=l(a),a=d(c),null==a&&(a=E(c),"scroll"===p.dom.getAttribute(c,n.dataUiLazyload)&&function(a,b){let c=(new Date).getTime();D(b===document.body?window:b).on("scroll",function(){const a=(new Date).getTime();100<a-c&&(c=a,t(b))})}(this,c)),!0;if("true"===p.dom.getAttribute(a,n.dataUiLazyload))return b=l(a),!0}else return!0;return!1}
const n=m("./OptionAttributes");c.prototype.componentize=function(a,c){C.trigger(this,"componentize:begin");if(null!=c){const d=b(a);null==d?H.push({element:a,waiting:[c]}):d.push(c)}else f(a);t(a);return this};c.prototype.applyOptions=function(a,b){e(a,b);return this};c.prototype.resolvePath=function(a){return u(a)};c.prototype.willLoadMore=function(){return 0<y.length||0<F.length};c.prototype.lazyLoad=function(a,b){return g(a,b)};c.prototype.dequeue=function(a){for(let b=0;b<y.length;b++)if(y[b].element===
a){y.splice(b,1);break}};c.prototype.setHost=function(a){C=a;return this};q.exports=function(){return new c};const r=m("../helpers/Logger")("ComponentContext.js"),p=m("../helpers/Util"),D=m("../helpers/ZxQuery"),F=[],y=[],x=[],B=[],M=function(){return{element:null,priority:0,visible:!0,lazy:!1}},N=m("./../helpers/AsynChain")({doWork:function(a,b){D(a.element).one("component:ready",function(){b()});return v(a.element)},willBreak:function(){return!1},status:function(a){switch(a){case "done":t()}}});
let K=!1,L=1,C=null,A=!1;navigator&&navigator.userAgent&&(A=(new RegExp(/bot|googlebot|crawler|spider|robot|crawling/i)).test(navigator.userAgent));A&&r.d(navigator.userAgent,"is a bot, ignoring `lazy-loading` option.");const H=[]},{"../helpers/Logger":2,"../helpers/Util":4,"../helpers/ZxQuery":5,"./../helpers/AsynChain":1,"./OptionAttributes":14}],13:[function(m,q,w){function c(c){const b=this;this._view=null;this.context=c;this._fieldCache=[];this._childNodes=[];this.saveView=function(){this.restoreView();
this.view().children().each(function(a,c){b._childNodes.push(c)})};this.restoreView=function(){0<this._childNodes.length&&(b.view().html(""),g.each(b._childNodes,function(a,c){b.view().append(c)}),this._childNodes.length=0)};this.on=function(a,b){this.addEvent(a,b);return this};this.mapEvent=function(a,b,c,e){null!=b&&(b.off(c,this.eventRouter),a[c]=e,b.on(c,this.eventRouter))};this.eventRouter=function(a){const f=b.view();"function"===typeof c._behaviorMap[a.type]&&c._behaviorMap[a.type].call(f,
a,a.detail,f);"function"===typeof c._eventMap[a.type]&&c._eventMap[a.type].call(f,a,a.detail,f)};const f=c.options();let a=null;if(null!=f.on)for(let c in f.on)f.on.hasOwnProperty(c)&&(a=f.on[c],b.addEvent(c,a));if(null!=f.behavior)for(let c in f.behavior)f.behavior.hasOwnProperty(c)&&(a=f.behavior[c],b.addBehavior(c,a));c.controller().call(this,this);return this}const g=m("../helpers/ZxQuery");c.prototype.init=null;c.prototype.create=null;c.prototype.update=null;c.prototype.destroy=null;c.prototype.addEvent=
...
function(c,b){if("object"===typeof c){const b=this;g.each(c,function(a,c){b.context[a]=c})}else this.context[c]=b;return this};c.prototype.loadCss=function(c){this.context.loadCss(c);return this};c.prototype.loadHtml=function(c){this.saveView();this.context.loadHtml(c);return this};c.prototype.log={};c.prototype.for=function(c){return this};q.exports=c},{"../helpers/ZxQuery":5}],14:[function(m,q,w){m=Object.freeze({dataBindModel:"z-model,data-bind-model",dataBindTo:"z-bind,data-bind-to",dataUiComponent:"z-component",
dataUiContext:"z-context,data-ui-context",dataUiField:"z-field,data-ui-field",dataUiInclude:"z-include,data-ui-include",dataUiLazyload:"z-lazy,data-ui-lazyload",dataUiLoad:"z-load,data-ui-load",dataUiLoaded:"z-loaded",dataUiOptions:"z-options,data-ui-options",dataUiPriority:"z-priority,data-ui-priority",dataUiView:"z-view,data-ui-view",zuixLoaded:"zuix-loaded"});q.exports=m},{}],15:[function(m,q,w){function c(b){const c=this._context=b;this._mutationObserver=null;this._mutationCallback=function(a,
b){const h=f.dom.queryAttribute(g.dataUiComponent);for(let b of a)"childList"===b.type&&b.addedNodes.forEach(function(a){if(a instanceof Element){let d=zuix.$(a).parent(h);if(!1!==c.options().css&&null==d.attr("_ctrl_")){if(d.get()===c._container||d.get()===c._view){var b=!1;for(var e=0;e<a.attributes.length;e++)if(a.attributes[e].name.startsWith("_css_")){b=!0;break}b||f.dom.setAttribute(a,c.getCssId(),"")}}else{b=0;do b++,d=d.parent(h);while(10>b&&null!=d.get()&&null!=d.attr("_ctrl_"));if(d.get()){d=
zuix.context(d);b=!1;for(e=0;e<a.attributes.length;e++)if(a.attributes[e].name.startsWith("_css_")){b=!0;break}b||(f.dom.setAttribute(a,d.getCssId(),""),zuix.$(a).find("*").each(function(){this.attr(d.getCssId(),"")}))}}}})}}const g=m("./OptionAttributes"),f=m("../helpers/Util");c.prototype.start=function(){this.stop();this._mutationObserver=new MutationObserver(this._mutationCallback);this._mutationObserver.observe(this._context._view,{attributes:!1,childList:!0,subtree:!0})};c.prototype.stop=function(){null!=
this._mutationObserver&&(this._mutationObserver.disconnect(),this._mutationObserver=null)};q.exports=c},{"../helpers/Util":4,"./OptionAttributes":14}],16:[function(m,q,w){function c(){x.setHost(this);this._store=[];this._fieldCache=[];return this}function g(a){"function"!==typeof a["for"]&&(a["for"]=function(b){return K[b]=a});return a}function f(a,b,c){r.isNoU(c)&&(c=this);null==c._fieldCache&&(c._fieldCache={});let d=null;"undefined"===typeof c._fieldCache[a]?(d=p(b).find(r.dom.queryAttribute(B.dataUiField,
a)),null!=d&&0<d.length()&&(c._fieldCache[a]=d,1===d.length()&&r.isNoU(d.field)&&(d.field=function(a){return f(a,d,d)}))):d=c._fieldCache[a];return d}function b(a){let b=zuix.store("config");null!=b&&null!=b[location.host]&&(b=b[location.host]);a=x.resolvePath(a);!a.startsWith("//")&&0>a.indexOf("://")&&(a=(null!=b&&null!=b.resourcePath?b.resourcePath:"")+a);return a}function h(a,b){let c=e(a.componentId);null!==c&&null==b.controller&&null==a.controller()&&(a.controller(c.controller),n.t(a.componentId+
":js","component:cached:js"));if(r.isNoU(b.view)){if(null!==c&&(null!=c.view&&(a.view(c.view),n.t(a.componentId+":html","component:cached:html")),!1!==b.css&&(b.css=!1,c.css_applied||(c.css_applied=!0,a.style(c.css),n.t(a.componentId+":css","component:cached:css")))),r.isNoU(a.view()))return H("resource-loader").queue(a.componentId+":html",function(){A[a.componentId]=this;a.loadHtml({cext:b.cext,caching:J,success:function(d){null==c&&(c=l(a));c.view=d;delete c.controller;!1!==b.css?(A[a.componentId].step(a.componentId+
":css"),a.loadCss({caching:J,success:function(a){c.css=a},error:function(b){n.e(b,a)},then:function(){k(a,A[a.componentId])}})):k(a,A[a.componentId])},error:function(c){n.e(c,a);r.isFunction(b.error)&&a.error.call(a,c,a)}})},b.priority),a}else a.view(b.view);null==a.controller()?H("resource-loader").queue(a.componentId+":js",function(){A[a.componentId]=this;k(a,A[a.componentId])},M.length):k(a);return a}function a(a){a=new F(zuix,a,v);M.push(a);return a}function t(a,b){let c=null;if(a instanceof p.ZxQuery)a=
a.get();else if("string"===typeof a){const b=p.find(r.dom.queryAttribute(B.dataUiContext,a));0<b.length()&&(a=b.get())}p.each(M,function(b,d){if(a instanceof Element&&(d.view()===a||d.container()===a)||r.objectEquals(d.contextId,a))return c=d,!1});if("function"===typeof b&&(a instanceof Element||a instanceof p.ZxQuery))if(null!=c&&c.isReady)b.call(c,c);else p(a).one("component:ready",function(){c=zuix.context(this);b.call(c,c)});return c}function v(a,b,c){r.isFunction(N[b])&&N[b].call(a,c,a)}function u(a){null!=
a&&(J=a);return J}function e(a){let b=null;p.each(I,function(c,d){if(r.objectEquals(d.componentId,a))return b=d,!1});return b}function k(a,c){if("undefined"===typeof a.options().controller&&null===a.controller())if(n.d(a.componentId,"controller:load"),r.isNoU(c)||c.step(a.componentId+":js"),r.isFunction(K[a.componentId]))a.controller(K[a.componentId]),d(a,c);else{const e=function(c){const e=a.componentId+".js"+(J?"":"?"+(new Date).getTime());p.ajax({url:b(e),success:function(b){try{const c=b.indexOf("function"),
d=b.indexOf(".load");1<d&&d<c&&(b=b.substring(0,d-4));const e=b.indexOf(".controller");1<e&&e<c&&(b=b.substring(e+11));const f=b.indexOf("//<--controller");0<f&&(b=b.substring(0,f));b+='\n//# sourceURL="'+a.componentId+'.js"\n';a.controller(O(b))}catch(Q){n.e(Error(),Q,b,a),r.isFunction(a.error)&&a.error.call(a,Q,a)}},error:function(b){n.e(b,Error(),a);r.isFunction(a.error)&&a.error.call(a,b,a)},then:function(){d(a,c)}})};r.isNoU(c)?H("resource-loader").queue(a.componentId+":js",function(){e(A[a.componentId]=
this)},a.options().priority):e(c)}else d(a,c)}function l(a){var b=a.view().innerHTML;b=p.wrapElement("div",b);b={componentId:a.componentId,view:b.innerHTML,css:a._css,controller:a.controller()};I.push(b);n.t(a.componentId,"bundle:added");return b}function d(a,b){A[a.componentId]=null;if(r.isNoU(a.view()))n.e(a.componentId,"component:view:undefined");else{let d=e(a.componentId);a.options().viewDeferred?n.w(a.componentId,"component:deferred:load"):null===d?d=l(a):null==d.controller&&(d.controller=a.controller());
null!=b&&b.callback(function(){n.d(a.componentId,"controller:create:deferred");E(a._c)});var c=p(a.view());null==c.attr(B.dataUiContext)&&c.attr(B.dataUiContext,a.contextId);n.d(a.componentId,"component:initializing");if(r.isFunction(a.controller())){c=a._c=new y(a);c.log=m("../helpers/Logger")(a.contextId);"function"===typeof c.init&&c.init();if(!r.isNoU(c.view()))if(null==c.view().attr(B.dataUiComponent)&&c.view().attr(B.dataUiComponent,""),r.isNoU(a.model())&&!r.isNoU(a.view())&&a.viewToModel(),
a.options().viewDeferred){a.options().viewDeferred=!1;c.saveView();null===d&&(d={componentId:a.componentId,controller:a.controller()},I.push(d),n.t(a.componentId,"bundle:added"),n.d(a.componentId,"component:deferred:load"));let e=-1;!1!==a.options().css&&(null==d.css?(-1===e&&(e=0),e++,a.loadCss({caching:J,success:function(b){null==d.css&&(d.css=b);n.d(a.componentId,"component:deferred:css",e)},then:function(){0===--e&&null!=b&&b.end()}})):a.style(d.css));!1!==a.options().html&&(null==d.view?(-1===
e&&(e=0),e++,a.loadHtml({cext:a.options().cext,caching:J,success:function(b){null==d.view&&(d.view=b);n.d(a.componentId,"component:deferred:html",e)},error:function(b){n.e(b,a);r.isFunction(a.options().error)&&a.options().error.call(a,b,a)},then:function(){0===--e&&null!=b&&b.end()}})):a.view(d.view));-1===e&&null!=b&&b.end()}else null!=b&&b.end();c.trigger("view:apply");null==b&&(n.d(a.componentId,"controller:create"),E(c))}else n.w(a.componentId,"component:controller:undefined")}}function E(a){n.t(a.context.componentId,
"controller:init","timer:init:start");a.view().find(r.dom.queryAttribute(B.dataUiLoaded,"false",r.dom.cssNot(B.dataUiComponent))).each(function(a,b){this.attr(B.dataUiLoaded,null)});a.field=function(b){b=f(b,a.view(),a);b.on=function(b,c,d,e){if("string"===typeof c){const b=c;c=function(){a.trigger(b,d,e)}}return p.ZxQuery.prototype.on.call(this,b,c)};return b};r.isFunction(a.create)&&a.create();a.trigger("view:create");r.isFunction(a.context.ready)&&a.context.ready.call(a.context,a.context);a.trigger("component:ready",
a.view(),!0);a.context.isReady=!0;n.t(a.context.componentId,"controller:init","timer:init:stop");n.i(a.context.componentId,"component:loaded",a.context.contextId);if(null!=C[a.context.componentId]){const b=C[a.context.componentId];C[a.context.componentId]=null;let c;for(;null!=b&&null!=(c=b.shift());)h(c.c,c.o)}zuix.componentize(a.view())}function O(a){let b=function(a){};if("string"===typeof a)try{b=eval.call(this,a)}catch(S){n.e(this,S,a)}return b}const n=m("../helpers/Logger")("Zuix.js"),r=m("../helpers/Util"),
p=m("../helpers/ZxQuery"),D=m("../helpers/TaskQueue");w=m("../observable/ObjectObserver");const F=m("./ComponentContext"),y=m("./ContextController"),x=m("./Componentizer")(),B=m("./OptionAttributes");m("./ComponentCache");const M=[],N=[],K={},L=[],C={},A=[],H=function(a){r.isNoU(L[a])&&(L[a]=new D(function(a,b,c){v(a,b,c)}));return L[a]};let I=[],P=0,J=!0;const R=new w;c.prototype.field=function(a,b){return f.call(this,a,b)};c.prototype.load=function(b,c){{b=x.resolvePath(b);let d;r.isNoU(c)?(c={},
d=new F(zuix,c,v)):(c.componentId=b,r.isNoU(c.contextId)?(!1===c&&(c={}),c.contextId="zuix-ctx-"+ ++P,d=a(c)):(d=t(c.contextId),null!==d?d.options(c):d=a(c)));d.componentId!=b&&(d.componentId=b);r.isFunction(c.ready)&&(d.ready=c.ready);r.isFunction(c.error)&&(d.error=c.error);null==A[b]?(A[b]=!0,c=h(d,c)):(null==C[b]&&(C[b]=[]),C[b].push({c:d,o:c}),c=d)}return c};c.prototype.unload=function(a){if(a instanceof Element){const b=a;a=zuix.context(b);x.dequeue(b)}r.isNoU(a)||a.dispose();return this};c.prototype.controller=
...
q.exports=function(a){const b=new c;"loading"!=document.readyState?b.componentize():document.addEventListener("DOMContentLoaded",function(){b.componentize()});n.monitor(function(a,c){r.isFunction(b.monitor)&&b.monitor(a,Array.prototype.slice.call(c))});return b}},{"../helpers/Logger":2,"../helpers/TaskQueue":3,"../helpers/Util":4,"../helpers/ZxQuery":5,"../observable/ObjectObserver":7,"./ComponentCache":10,"./ComponentContext":11,"./Componentizer":12,"./ContextController":13,"./OptionAttributes":14}]},
{},[6])(6)});
