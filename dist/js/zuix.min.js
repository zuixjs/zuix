...
d)}):g.setAttribute(h,d)},cssNot:function(g,h){const d=g.split(",");let b="";d.forEach(function(k,a){b=null!=h?b+(":not(["+k+'="'+h+'"])'):b+(":not(["+k+"])");a<d.length-1&&(b+=",")});return function(b){return{get:function(a){const e=b.split(",");return a>=e.length?e[0]:e[a]}}}(b)}}}},{}],6:[function(n,q,v){function c(f){d(this,f.type,f)}function g(f,e,b,d){let B=!1;l.each(z,function(){if(this.element===f&&this.path===e&&this.handler===b)return a.w("Handler already registered",f,e,b),B=!0,!1});B||
(z.push({element:f,path:e,handler:b,opgions:d}),f.addEventListener(e,c,!C||null!=d&&!1===d.passive?!1:{passive:!0}))}function h(f,a,e){let b=1,d=-1;l.each(z,function(c){this.element===f&&this.path===a&&this.handler===e&&(b--,d=c)});-1!==d&&z.splice(d,1);0===b&&f.removeEventListener(a,c)}function d(f,a,e){const b=l(f);l.each(z,function(){this.element===f&&this.path===a&&this.handler.call(b,e,b)})}function b(f){l.each(z,function(){this.element===f&&(a.t("Removing event handler",this.element,this.path,
this.handler),h(this.element,this.path,this.handler))})}function k(f){this._selection=[];"undefined"===typeof f&&(f=document.documentElement);if(f instanceof k)return f;if(f instanceof HTMLCollection||f instanceof NodeList){const a=this._selection=[];l.each(f,function(f,e){a.push(e)})}else if(Array.isArray(f))this._selection=f;else if(f===window||f instanceof HTMLElement||f instanceof Node)this._selection=[f];else if("string"===typeof f)this._selection=document.documentElement.querySelectorAll(f);
else if(null!==f)throw a.e("ZxQuery cannot wrap object of this type.",typeof f,f),Error("ZxQuery cannot wrap object of this type.");return this}const a=n("./Logger")("TaskQueue.js"),e=n("./Util.js");let C=e.hasPassiveEvents();const z=[];k.prototype.length=function(){return this._selection.length};k.prototype.parent=function(f){return e.isNoU(f)?new k(this._selection[0].parentNode):new k(l.getClosest(this._selection[0],f))};k.prototype.children=function(f){return e.isNoU(f)?new k(this._selection[0].children):
new k(this._selection[0].querySelectorAll(f))};k.prototype.reverse=function(){this._selection=Array.prototype.slice.call(this._selection,0).reverse();return this};k.prototype.get=function(f){e.isNoU(f)&&(f=0);return this._selection[f]};k.prototype.eq=function(f){const a=this._selection;let e=a[f];1<arguments.length&&(e=[],l.each(arguments,function(f,b){null!=a[b]&&e.push(a[b])}));return new k(e)};k.prototype.find=function(f){return new k(this._selection[0].querySelectorAll(f))};k.prototype.each=function(f){l.each(this._selection,
f);return this};k.prototype.attr=function(f,a){const b=this;if("object"===typeof f)l.each(f,function(f,a){b.each(function(b,d){e.dom.setAttribute(d,f,a)})});else{if("undefined"==typeof a)return e.dom.getAttribute(this._selection[0],f);null===a?this._selection[0].removeAttribute(f):this.each(function(b,d){e.dom.setAttribute(this.get(),f,a)})}return this};k.prototype.trigger=function(f,a){let e;window.CustomEvent?e=new CustomEvent(f,{detail:a}):(e=document.createEvent("CustomEvent"),e.initCustomEvent(f,
!0,!0,a));this.each(function(f,a){a.dispatchEvent(e)});return this};k.prototype.one=function(f,a){let e=!1;this.on(f,function(b,d){e||(e=!0,l(this).off(f,a),a.call(this,b,d,this))});return this};k.prototype.on=function(f,a){const e=f.match(/\S+/g)||[];let b;"function"!==typeof a&&(b=a,a=b.handler);this.each(function(f,d){l.each(e,function(f,e){g(d,e,a,b)})});return this};k.prototype.off=function(f,a){const e=f.match(/\S+/g)||[];this.each(function(f,b){l.each(e,function(f,e){h(b,e,a)})});return this};
k.prototype.reset=function(){this.each(function(f,a){b(a)});return this};k.prototype.isEmpty=function(){return 0===this._selection[0].innerHTML.replace(/\s/g,"").length};k.prototype.position=function(){return null!=this._selection[0]?l.getPosition(this._selection[0]):{x:-1,y:-1,visible:!1}};k.prototype.css=function(f,a){const b=this;if("object"===typeof f)l.each(f,function(f,a){b.each(function(e,b){b.style[f]=a})});else{if(e.isNoU(a))return this._selection[0].style[f];b.each(function(e,b){b.style[f]=
a})}return this};k.prototype.addClass=function(f){const a=f.match(/\S+/g)||[];l.each(this._selection,function(e,b){b.classList?l.each(a,function(f,a){b.classList.add(a)}):b.className+=" "+f});return this};k.prototype.hasClass=function(f){return l.hasClass(this._selection[0],f)};k.prototype.removeClass=function(f){const a=f.match(/\S+/g)||[];l.each(this._selection,function(e,b){b.classList?l.each(a,function(a,f){b.classList.remove(f)}):b.className=b.className.replace(new RegExp("(^|\\b)"+f.split(" ").join("|")+
...
this._selection[0].insertBefore(a,this._selection[0].firstElementChild);return this};k.prototype.detach=function(){const f=this._selection[0],b=f.parentNode;null!=b&&(f.__zuix_oldParent=b,f.__zuix_oldIndex=Array.prototype.indexOf.call(b.children,f),b.removeChild(f),a.t("Detached from parent",b,f));return this};k.prototype.attach=function(){const a=this._selection[0];null!=a.parentNode&&null!=a.__zuix_oldParent&&a.parentNode.removeChild(a);null==a.parentNode&&null!=a.__zuix_oldParent&&(l(a.__zuix_oldParent).insert(a.__zuix_oldIndex,
a),a.__zuix_oldParent=null,delete a.__zuix_oldParent,delete a.__zuix_oldIndex);return this};k.prototype.display=function(a){if(e.isNoU(a))return this._selection[0].style.display;l.each(this._selection,function(b,f){f.style.display=a});return this};k.prototype.visibility=function(a){if(e.isNoU(a))return this._selection[0].style.visibility;l.each(this._selection,function(b,f){f.style.visibility=a});return this};k.prototype.show=function(a){return this.display(null==a?"":a)};k.prototype.hide=function(){return this.display("none")};
const l=function(a){return new k(a)};l.find=function(a){return l().find(a)};l.each=function(a,b){const f=null==a?0:Object.keys(a).length;if(0<f){let e=0;for(let d in a)if(a.hasOwnProperty(d)){let c=a[d];c instanceof Element&&(c=l(c));if(!1===b.call(c,d,a[d],c))break;e++;if(e>=f)break}}return this};l.ajax=function(a){let b;b=e.isNoU(a)||e.isNoU(a.url)?a:a.url;const f=new XMLHttpRequest;f.onload=function(){200===f.status?e.isFunction(a.success)&&a.success(f.responseText):e.isFunction(a.error)&&a.error(f,
f.statusText,f.status);e.isFunction(a.then)&&a.then(f)};f.onerror=function(b,f,d){e.isFunction(a.error)&&a.error(b,f,d)};"function"==typeof a.beforeSend&&a.beforeSend(f);try{f.open("GET",b),f.send()}catch(J){e.isFunction(a.error)&&a.error(f,f.statusText,f.status,J)}return this};l.hasClass=function(a,b){b=b.match(/\S+/g)||[];let e=!1;l.each(b,function(b,f){if(e=a.classList?a.classList.contains(f):(new RegExp("(^| )"+f+"( |$)","gi")).test(a.className))return!1});return e};l.classExists=function(a){a=
a.match(/\S+/g)||[];let b=!1;l.each(a,function(a,e){a=document.styleSheets;if(null!=a)for(let f=0;f<a.length;f++)try{const d=a[f].rules||a[f].cssRules;if(null!=d)for(let a=0;a<d.length;a++)if(d[a].selectorText===e){b=!0;break}}catch(p){if("SecurityError"!==p.name&&"InvalidAccessError"!==p.name)throw p;}});return b};l.wrapElement=function(a,b){a=document.createElement(a);"string"===typeof b?a.innerHTML=b:a.appendChild(b);return a};l.wrapCss=function(b,e){const f=/(([a-zA-Z0-9\240-\377=:-_\n,.@]+.*){([^{}]|((.*){([^}]+)[}]))*})/g;
let d="",c;e=e.replace(/\/\*[\s\S]*?\*\/|([^:]|^)\/\/.*$/g,"");do if((c=f.exec(e))&&1<c.length){var h=c[2];if(null!=h&&0<h.length){h=h.replace(/\n/g,"");const a=h.split(",");let e=!1;l.each(a,function(f,c){"."===c.replace(" ","")?d+="\n"+b+" ":"@"===c.trim()[0]?(d+=c+" ",c.trim().toLowerCase().startsWith("@media")&&(e=!0)):d+="\n"+b+"\n"+c+" ";f<a.length-1&&(d+=", ")});e?(h=l.wrapCss(b,c[1].substring(c[2].length).replace(/^{([^\0]*?)}$/,"$1")),d+="{\n  "+h+"\n}"):d+=c[1].substring(c[2].length)+"\n"}else a.w("z$.wrapCss was unable to parse rule.",
h,c)}while(c);""!==d&&(e=d);return e};l.appendCss=function(a,b,d){const f=document.head||document.getElementsByTagName("head")[0];let c=null;e.isNoU(b)?(b=document.getElementById(d),null!=b&&f.removeChild(b)):f.removeChild(b);"string"===typeof a?(c=document.createElement("style"),c.type="text/css",c.id=d,c.styleSheet?c.styleSheet.cssText=a:c.appendChild(document.createTextNode(a))):a instanceof Element&&(c=a);e.isNoU(c)||f.appendChild(c);return c};l.replaceCssVars=function(a,b){const e=new RegExp(/\B\$var\[(.*[^\[\]])]/g);
let f="",c=0,d=0,h;for(;h=e.exec(a);){let e=h[0];if(1<h.length){var g=h[1];let a=b;if(0<g.indexOf(".")){g=g.split(".");for(let b=0;b<g.length-1&&(a=a[g[b]],"undefined"!==typeof a);b++);"undefined"!==typeof a&&(e=a[g[g.length-1]],c++)}else"undefined"!==typeof a[g]&&(e=a[g],c++)}f+=a.substr(d,h.index-d)+e;d=h.index+h[0].length}0<c&&(a=f+=a.substr(d));return a};l.replaceBraces=function(a,b){const f=new RegExp(/{?{.*?}?}/g);let c="",d=0,h=0;for(var g;g=f.exec(a);){if("string"===typeof g[0]&&(0===g[0].trim().length||
0<=g[0].indexOf("\n"))){g=a.substr(h,g.index-h)+g[0];c+=g;h+=g.length;continue}let f=g[0];if("function"===typeof b){const a=b(g[0]);e.isNoU(a)||(f=a,d++)}c+=a.substr(h,g.index-h)+f;h=g.index+g[0].length}return 0<d?c+=a.substr(h):null};l.getClosest=function(a,b){for(;a&&a!==document;a=a.parentNode)if(a.matches(b))return a;return null};l.getPosition=function(a,b){var e;{var c=e=0,d=a.getBoundingClientRect();let b=a;for(;b;){if("body"===b.tagName.toLowerCase()){const a=b.scrollTop||document.documentElement.scrollTop;
...
2-c.top)/c.height};a=l(a);!b&&a.hasClass("--ui--visible")?(a.removeClass("--ui--visible"),e.event="exit"):b?b&&(a.hasClass("--ui--visible")?e.event="scroll":(e.event="enter",a.addClass("--ui--visible"))):e.event="off-scroll"}return e};l.ZxQuery=k;Element.prototype.matches||(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.mozMatchesSelector||Element.prototype.msMatchesSelector||Element.prototype.oMatchesSelector||Element.prototype.webkitMatchesSelector||function(a){a=
...
this.charCodeAt(b);a=(a<<5)-a+e;a|=0}return a};String.prototype.startsWith||(String.prototype.startsWith=function(a,b){return this.substr(!b||0>b?0:+b,a.length)===a});q.exports=l},{"./Logger":2,"./Util.js":5}],7:[function(n,q,v){n=n("./zuix/Zuix.js");"object"===typeof q&&q.exports?q.exports=n.call(this):this.zuix=n.call(this)},{"./zuix/Zuix.js":13}],8:[function(n,q,v){q.exports=function(c){return null}},{}],9:[function(n,q,v){function c(a,e,c){k=a;this._options=null;this.contextId=null==e||null==
e.contextId?null:e.contextId;this.componentId=null;this.trigger=function(a,b,e){"function"===typeof c&&c(a,b,e)};this.behavior=this._controller=this._style=this._css=this._view=this._model=this._container=null;this._eventMap=[];this._behaviorMap=[];this._c=null;this._modelListener=Object.assign({context:null,get:function(a,b,e,c){},set:function(a,e,c,g,k){const f=d(this.context.view());let l=f.find(b.dom.queryAttribute(h.dataBindTo,g));null==l.get()&&(l=f.find(b.dom.queryAttribute(h.dataUiField,g)));
l.get()&&this.context.dataBind(l.get(),c);this.context._c&&"function"===typeof this.context._c.update&&this.context._c.update(a,e,c,g,k)}},{context:this});this.options(e);return this}const g=n("../helpers/Logger")("ComponentContext.js"),h=n("./OptionAttributes"),d=n("../helpers/ZxQuery"),b=n("../helpers/Util");let k=null;c.prototype.container=function(a){if(null==a)return this._container;a instanceof d.ZxQuery&&(a=a.get());this._container=a;return this};c.prototype.view=function(a){if("undefined"===
typeof a)return this._view;a instanceof d.ZxQuery&&(a=a.get());g.t(this.componentId,"view:attach","timer:view:start");if("string"===typeof a){a={content:a};this.trigger(this,"html:parse",a);a=a.content;const b=d.wrapElement("div",a);null!=b.firstElementChild&&(null!=b.firstElementChild.getAttribute(h.dataUiView)?1===b.children.length&&(a=b.firstElementChild.innerHTML):a=b.innerHTML);null!=this._container?(this._view=this._container,this._view.innerHTML+=a):null!=this._view?this._view.innerHTML=a:
this._view=b;d(this._view).find("script").each(function(a,b){"true"!==this.attr(h.zuixLoaded)&&(this.attr(h.zuixLoaded,"true"),eval.call(window,b.innerHTML))});this.trigger(this,"view:process",d(this._view))}else a instanceof d.ZxQuery&&(a=a.get()),null!=this._container?(this._view=d.wrapElement("div",a.outerHTML).firstElementChild,this._view.removeAttribute(h.dataUiView),this._container.appendChild(this._view),this._view=this._container):this._view=a;a=d(this._view);!1===this._options.css?a.addClass("zuix-css-ignore"):
...
a.success.call(c,e,c)},error:function(e){g.e(e,c);b.isFunction(a.error)&&a.error.call(c,e,c)},then:function(){b.isFunction(a.then)&&a.then.call(c,c)}});return this};c.prototype.loadHtml=function(a,e){const c=this;let n=c.componentId;b.isNoU(a)&&(a={});b.isNoU(a.caching)||(e=a.caching);b.isNoU(a.path)||(n=a.path);var l=k.store("zuix.inlineViews");null==l&&(l=[],k.store("zuix.inlineViews",l));if(null!=l[n])c.view(l[n]),b.isFunction(a.success)&&a.success.call(c,l[n],c),b.isFunction(a.then)&&a.then.call(c,
c);else{const f=d().find(b.dom.queryAttribute(h.dataUiView,n,b.dom.cssNot(h.dataUiComponent,0)));0<f.length()?(e=f.get(0),l[n]=e.innerHTML,c.view()===e||null!=c.container()&&c.container().contains(e)?(f.attr(h.dataUiView,null),c._view=e,this.trigger(this,"view:process",d(c.view()))):c.view(e.innerHTML),b.isFunction(a.success)&&a.success.call(c,e.innerHTML,c),b.isFunction(a.then)&&a.then.call(c,c)):(l=b.isNoU(a.cext)?".html":a.cext,n==c.componentId&&(n+=l+(e?"":"?"+(new Date).getTime())),d.ajax({url:k.getResourcePath(n),
...
a instanceof t.ZxQuery&&(a=a.get());d(a);var b=m.dom.queryAttribute(r.dataUiLoad,null,m.dom.cssNot(r.dataUiLoaded))+","+m.dom.queryAttribute(r.dataUiInclude,null,m.dom.cssNot(r.dataUiLoaded));b=t(a).find(b);b=Array.prototype.slice.call(b._selection);y.push({element:a,waiting:b});a=[];for(var c=0;c<b.length;c++){var e=b[c],f=+e.getAttribute(r.dataUiPriority);isNaN(f)&&(f=0);let d=0;var u=e.parentNode;let h=!1;for(;null!=u&&u!==document;){d++;if(null!=u.getAttribute(r.dataUiView)){h=!0;break}u=u.parentNode}h||
(u=new A,u.element=e,u.priority=f+1E3*d,a.push(u))}b=0;for(c=0;c<a.length;c++){e=!1;for(f=0;f<x.length;f++)if(a[c].element===x[f].element){e=!0;break}e||(e=a[c].element,f=e.getAttribute(r.dataUiOptions),z(e,f),x.push(a[c]),b++)}p.t("componentize:count",x.length,b);(0===b||0===F.length&&0===x.length)&&E.trigger(this,"componentize:end")}function k(){x.sort(function(a,b){return a.priority-b.priority});let a=null,b=0<x.length?x.shift():null;for(;null!=b&&null!=b.element;){const c=J(b.element);g()&&c?
(b.lazy=!0,b.visible=t.getPosition(b.element,K).visible):(b.lazy=!1,b.visible=!0);if(null!=b.element&&b.visible){a={item:b,cancelable:b.lazy};break}if(0<x.length)b=x.shift();else break}return a}function a(a){b(a);a=k();null!=a&&L.append([a])}function e(b){var c=t(b);if(null!=c.attr(r.dataUiLoaded)||0<c.parent("pre,code").length())return!1;c.attr(r.dataUiLoaded,"true");let d=c.attr(r.dataUiOptions);m.isNoU(d)?d={}:(d=m.propertyFromPath(window,d),d=m.cloneObject(d)||{});var e=c.attr(r.dataUiContext);
if(!m.isNoU(e)){var f=E.context(e);null!==f&&(d=f.options());d.contextId=e}m.isNoU(d.view)&&!c.isEmpty()?(d.view=b,d.viewDeferred=!0):m.isNoU(d.view)&&m.isNoU(d.container)&&c.isEmpty()&&(d.container=b);e=c.attr(r.dataUiLoad);if(m.isNoU(e))if(e=c.attr(r.dataUiInclude),null!=e)e=C(e),c.attr(r.dataUiInclude,e),c.attr(r.dataUiComponent,e),m.isNoU(d.controller)&&(d.controller=function(){});else return!1;else e=C(e),c.attr(r.dataUiLoad,e);f=c.attr(r.dataBindModel);!m.isNoU(f)&&0<f.length&&(d.model=m.propertyFromPath(window,
f));c=c.attr(r.dataUiPriority);m.isNoU(c)||(d.priority=+c);t(b).one("component:ready",function(){h(b);a(b)});E.load(e,d);return!0}function C(a){if("@"===a[0]){let b=E.store("config"),c="https://zuixjs.github.io/zkit/lib/";null!=b&&null!=b[location.host]&&(b=b[location.host]);if(null!=b)switch(typeof b.libraryPath){case "object":t.each(b.libraryPath,function(b,d){return a.startsWith(b+"/")?(c=d,!1):!0});break;case "string":c=b.libraryPath}a=c+a.substring(a.indexOf("/")+1)}return a}function z(a,b){"string"===
typeof b&&(b=m.propertyFromPath(window,b));null!=a&&null!=b&&(null!=b.lazyLoad&&m.dom.setAttribute(a,r.dataUiLazyload,b.lazyLoad.toString().toLowerCase()),null!=b.contextId&&m.dom.setAttribute(a,r.dataUiContext,b.contextId.toString().toLowerCase()),null!=b.componentId&&m.dom.setAttribute(a,r.dataUiLoad,b.componentId.toString().toLowerCase()))}function l(a){for(let b=0;b<N.length;b++){const c=N[b];if(c.element===a)return c}return null}function f(a){a={element:a};N.push(a);return a}function B(a){for(let b=
0;b<w.length;b++){const c=w[b];if(c.element===a)return c}return null}function M(a){a={element:a};w.push(a);return a}function J(b){if("false"===b.getAttribute(r.dataUiLazyload))return!1;let c=l(b);if(null==c){var d=m.dom.queryAttribute(r.dataUiLazyload,"scroll")+","+m.dom.queryAttribute(r.dataUiLazyload,"true");d=t.getClosest(b.parentNode,d);if(null!=d)return c=f(b),b=B(d),null==b&&(b=M(d),"scroll"===d.getAttribute(r.dataUiLazyload)&&function(b,c){let u=(new Date).getTime();t(c===document.body?window:
c).on("scroll",function(){const b=(new Date).getTime();100<b-u&&(u=b,a(c))})}(this,d)),!0;if("true"===b.getAttribute(r.dataUiLazyload))return c=f(b),!0}else return!0;return!1}const r=n("./OptionAttributes");c.prototype.componentize=function(b,c){E.trigger(this,"componentize:begin");if(null!=c){const a=d(b);null==a?y.push({element:b,waiting:[c]}):a.push(c)}else h(b);a(b);return this};c.prototype.applyOptions=function(a,b){z(a,b);return this};c.prototype.resolvePath=function(a){return C(a)};c.prototype.willLoadMore=
function(){return 0<x.length||0<F.length};c.prototype.lazyLoad=function(a,b){return g(a,b)};c.prototype.dequeue=function(a){for(let b=0;b<x.length;b++)if(x[b].element===a){x.splice(b,1);break}};c.prototype.setHost=function(a){E=a;return this};q.exports=function(){return new c};const p=n("../helpers/Logger")("ComponentContext.js"),m=n("../helpers/Util"),t=n("../helpers/ZxQuery"),F=[],x=[],N=[],w=[],A=function(){return{element:null,priority:0,visible:!0,lazy:!1}},L=n("./../helpers/AsynChain")({doWork:function(a,
...
Object.freeze({dataBindModel:"data-bind-model",dataBindTo:"data-bind-to",dataUiComponent:"z-component",dataUiContext:"data-ui-context,z-context",dataUiField:"data-ui-field,z-field",dataUiInclude:"data-ui-include,z-include",dataUiLazyload:"data-ui-lazyload,z-lazyLoad",dataUiLoad:"data-ui-load,z-load",dataUiLoaded:"z-loaded",dataUiOptions:"data-ui-options,z-options",dataUiPriority:"data-ui-priority,z-priority",dataUiView:"data-ui-view,z-view",zuixLoaded:"zuix-loaded"});q.exports=n},{}],13:[function(n,
q,v){function c(){w.setHost(this);this._store=[];this._fieldCache=[];return this}function g(a){"function"!==typeof a["for"]&&(a["for"]=function(b){return K[b]=a});return a}function h(a,b,c){m.isNoU(c)&&(c=this);null==c._fieldCache&&(c._fieldCache={});let u=null;"undefined"===typeof c._fieldCache[a]?(u=t(b).find(m.dom.queryAttribute(A.dataUiField,a)),null!=u&&0<u.length()&&(c._fieldCache[a]=u,1===u.length()&&m.isNoU(u.field)&&(u.field=function(a){return h(a,u,u)}))):u=c._fieldCache[a];return u}function d(a){let b=
zuix.store("config");null!=b&&null!=b[location.host]&&(b=b[location.host]);a=w.resolvePath(a);!a.startsWith("//")&&0>a.indexOf("://")&&(a=(null!=b&&null!=b.resourcePath?b.resourcePath:"")+a);return a}function b(a,b){let c=l(a.componentId);null!==c&&null==b.controller&&null==a.controller()&&(a.controller(c.controller),p.t(a.componentId+":js","component:cached:js"));if(m.isNoU(b.view)){if(null!==c&&(null!=c.view&&(a.view(c.view),p.t(a.componentId+":html","component:cached:html")),!1!==b.css&&(b.css=
!1,c.css_applied||(c.css_applied=!0,a.style(c.css),p.t(a.componentId+":css","component:cached:css")))),m.isNoU(a.view()))return O("resource-loader").queue(a.componentId+":html",function(){y[a.componentId]=this;a.loadHtml({cext:b.cext,caching:I,success:function(d){null==c&&(c=B(a));c.view=d;delete c.controller;!1!==b.css?(y[a.componentId].step(a.componentId+":css"),a.loadCss({caching:I,success:function(a){c.css=a},error:function(b){p.e(b,a)},then:function(){f(a,y[a.componentId])}})):f(a,y[a.componentId])},
error:function(c){p.e(c,a);m.isFunction(b.error)&&a.error.call(a,c,a)}})},b.priority),a}else a.view(b.view);null==a.controller()?O("resource-loader").queue(a.componentId+":js",function(){y[a.componentId]=this;f(a,y[a.componentId])},L.length):f(a);return a}function k(a){if(a instanceof Element){const b=a;a=zuix.context(b);w.dequeue(b)}m.isNoU(a)||(m.isNoU(a._c)||(m.isNoU(a._c.view())||(a._c.view().attr(A.dataUiComponent,null),a._c.view().reset(),m.isNoU(a._c._fieldCache)||t.each(a._c._fieldCache,function(a,
b){b.reset()}),a.model(null),a._c.view().detach()),m.isFunction(a._c.destroy)&&a._c.destroy.call(a,a)),a=a.container(),null!=a&&null!=a.parentNode&&a.parentNode.removeChild(a))}function a(a){a=new x(zuix,a,C);L.push(a);return a}function e(a,b){let c=null;if(a instanceof t.ZxQuery)a=a.get();else if("string"===typeof a){const b=t.find(m.dom.queryAttribute(A.dataUiContext,a));0<b.length()&&(a=b.get())}t.each(L,function(b,d){if(a instanceof Element&&(d.view()===a||d.container()===a)||m.objectEquals(d.contextId,
a))return c=d,!1});if("function"===typeof b&&(a instanceof Element||a instanceof t.ZxQuery))if(null!=c&&c.isReady)b.call(c,c);else t(a).one("component:ready",function(){c=zuix.context(this);b.call(c,c)});return c}function C(a,b,c){m.isFunction(H[b])&&H[b].call(a,c,a)}function z(a){null!=a&&(I=a);return I}function l(a){let b=null;t.each(G,function(c,d){if(m.objectEquals(d.componentId,a))return b=d,!1});return b}function f(a,b){if("undefined"===typeof a.options().controller&&null===a.controller())if(p.d(a.componentId,
"controller:load"),m.isNoU(b)||b.step(a.componentId+":js"),m.isFunction(K[a.componentId]))a.controller(K[a.componentId]),M(a,b);else{const c=function(b){const c=a.componentId+".js"+(I?"":"?"+(new Date).getTime());t.ajax({url:d(c),success:function(b){try{const c=b.indexOf("function"),d=b.indexOf(".load");1<d&&d<c&&(b=b.substring(0,d-4));const e=b.indexOf(".controller");1<e&&e<c&&(b=b.substring(e+11));const f=b.indexOf("//<--controller");0<f&&(b=b.substring(0,f));b+='\n//# sourceURL="'+a.componentId+
'.js"\n';a.controller(r(b))}catch(Q){p.e(Error(),Q,b,a),m.isFunction(a.error)&&a.error.call(a,Q,a)}},error:function(b){p.e(b,Error(),a);m.isFunction(a.error)&&a.error.call(a,b,a)},then:function(){M(a,b)}})};m.isNoU(b)?O("resource-loader").queue(a.componentId+":js",function(){c(y[a.componentId]=this)},a.options().priority):c(b)}else M(a,b)}function B(a){var b=a.view().innerHTML;b=t.wrapElement("div",b);b={componentId:a.componentId,view:b.innerHTML,css:a._css,controller:a.controller()};G.push(b);p.t(a.componentId,
"bundle:added");return b}function M(a,b){y[a.componentId]=null;if(m.isNoU(a.view()))p.e(a.componentId,"component:view:undefined");else{let d=l(a.componentId);a.options().viewDeferred?p.w(a.componentId,"component:deferred:load"):null===d?d=B(a):null==d.controller&&(d.controller=a.controller());null!=b&&b.callback(function(){p.d(a.componentId,"controller:create:deferred");J(a._c)});var c=t(a.view());null==c.attr(A.dataUiContext)&&c.attr(A.dataUiContext,a.contextId);p.d(a.componentId,"component:initializing");
if(m.isFunction(a.controller())){c=a._c=new N(a);c.log=n("../helpers/Logger")(a.contextId);"function"===typeof c.init&&c.init();if(!m.isNoU(c.view()))if(null==c.view().attr(A.dataUiComponent)&&c.view().attr(A.dataUiComponent,a.componentId),m.isNoU(a.model())&&!m.isNoU(a.view())&&a.viewToModel(),c.trigger("view:apply"),a.options().viewDeferred){a.options().viewDeferred=!1;c.saveView();null===d&&(d={componentId:a.componentId,controller:a.controller()},G.push(d),p.t(a.componentId,"bundle:added"),p.d(a.componentId,
"component:deferred:load"));let e=-1;!1!==a.options().css&&(null==d.css?(-1===e&&(e=0),e++,a.loadCss({caching:I,success:function(b){null==d.css&&(d.css=b);p.d(a.componentId,"component:deferred:css",e)},then:function(){0===--e&&null!=b&&b.end()}})):a.style(d.css));!1!==a.options().html&&(null==d.view?(-1===e&&(e=0),e++,a.loadHtml({cext:a.options().cext,caching:I,success:function(b){null==d.view&&(d.view=b);p.d(a.componentId,"component:deferred:html",e)},error:function(b){p.e(b,a);m.isFunction(a.options().error)&&
a.options().error.call(a,b,a)},then:function(){0===--e&&null!=b&&b.end()}})):a.view(d.view));-1===e&&null!=b&&b.end()}else null!=b&&b.end();null==b&&(p.d(a.componentId,"controller:create"),J(c))}else p.w(a.componentId,"component:controller:undefined")}}function J(a){p.t(a.context.componentId,"controller:init","timer:init:start");a.view().find(m.dom.queryAttribute(A.dataUiLoaded,"false",m.dom.cssNot(A.dataUiComponent))).each(function(a,b){this.attr(A.dataUiLoaded,null)});a.field=function(b){b=h(b,
a.view(),a);b.on=function(b,c,d,e){if("string"===typeof c){const b=c;c=function(){a.trigger(b,d,e)}}return t.ZxQuery.prototype.on.call(this,b,c)};return b};m.isFunction(a.create)&&a.create();a.trigger("view:create");m.isFunction(a.context.ready)&&a.context.ready.call(a.context,a.context);a.trigger("component:ready",a.view(),!0);a.context.isReady=!0;p.t(a.context.componentId,"controller:init","timer:init:stop");p.i(a.context.componentId,"component:loaded",a.context.contextId);if(null!=D[a.context.componentId]){const c=
D[a.context.componentId];D[a.context.componentId]=null;let d;for(;null!=c&&null!=(d=c.shift());)b(d.c,d.o)}zuix.componentize(a.view())}function r(a){let b=function(a){};if("string"===typeof a)try{b=eval.call(this,a)}catch(S){p.e(this,S,a)}return b}const p=n("../helpers/Logger")("Zuix.js"),m=n("../helpers/Util"),t=n("../helpers/ZxQuery"),F=n("../helpers/TaskQueue");v=n("../helpers/ObjectObserver");const x=n("./ComponentContext"),N=n("./ContextController"),w=n("./Componentizer")(),A=n("./OptionAttributes");
n("./ComponentCache");const L=[],H=[],K={},E=[],D={},y=[],O=function(a){m.isNoU(E[a])&&(E[a]=new F(function(a,b,c){C(a,b,c)}));return E[a]};let G=[],P=0,I=!0;const R=new v;c.prototype.field=function(a,b){return h.call(this,a,b)};c.prototype.load=function(c,d){{c=w.resolvePath(c);let f;m.isNoU(d)?(d={},f=new x(zuix,d,C)):(d.componentId=c,m.isNoU(d.contextId)?(!1===d&&(d={}),d.contextId="zuix-ctx-"+ ++P,f=a(d)):(f=e(d.contextId),null!==f?f.options(d):f=a(d)));f.componentId!=c&&(f.componentId=c);m.isFunction(d.ready)&&
(f.ready=d.ready);m.isFunction(d.error)&&(f.error=d.error);null==y[c]?(y[c]=!0,d=b(f,d)):(null==D[c]&&(D[c]=[]),D[c].push({c:f,o:d}),d=f)}return d};c.prototype.unload=function(a){k(a);return this};c.prototype.controller=function(a){return g.call(this,a)};c.prototype.context=function(a,b){return e.call(this,a,b)};c.prototype.createComponent=function(b,c){null==c&&(c={});m.isNoU(c.contextId)&&(c.contextId="zuix-ctx-"+ ++P);if(null!=e(c.contextId))throw Error("Context arelady exists.");c.container=document.createElement("div");
c.componentId=b;w.applyOptions(c.container,c);return a(c)};c.prototype.trigger=function(a,b,c){C(a,b,c);return this};c.prototype.hook=function(a,b){m.isNoU(b)?delete H[a]:H[a]=b;return this};c.prototype.using=function(a,b,c){b=w.resolvePath(b);a=a.toLowerCase();const d=a+"-"+b.hashCode();if("component"===a)a=e(d),null==a?zuix.load(b,{contextId:d,view:"",priority:-10,ready:function(a){"function"===typeof c&&c(b,a)},error:function(){c(b,null)}}):"function"===typeof c&&c(b,a);else{const e="style"===
a;if(0===t.find(a+'[id="'+d+'"]').length()){const f=document.head||document.getElementsByTagName("head")[0],g=document.createElement(a);g.type=e?"text/css":"text/javascript";g.id=d;f.appendChild(g);const h=function(a){e?g.styleSheet?g.styleSheet.cssText=a:g.appendChild(document.createTextNode(a)):g.innerText?g.innerText=a:g.appendChild(document.createTextNode(a));c&&c(b,d)},k="_res/"+a+"/"+d;a=l(k);null!=a?h(e?a.css:a.controller):t.ajax({url:b,success:function(a){G.push({componentId:k,view:null,css:e?
...
function(a){return R.observable(a)};c.prototype.bundle=function(a,b){if(m.isNoU(a))return G;if(a&&"boolean"===typeof a){p.t("bundle:start");const c=w.lazyLoad();w.lazyLoad(!1);w.componentize();"function"===typeof b&&(a=function(a){setTimeout(function(){w.willLoadMore()?(p.t("bundle:wait"),a(a)):(p.t("bundle:end"),w.lazyLoad(c),b())},1E3)},a(a))}else{for(let b=0;b<a.length;b++)a[b].css_applied&&delete a[b].css_applied,"string"===typeof a[b].controller&&(a[b].controller=eval(a[b].controller));G=a}return this};
c.prototype.$=t;c.prototype.TaskQueue=F;c.prototype.ObjectObserver=v;c.prototype.ZxQuery=t.ZxQuery;c.prototype.dumpCache=function(){return G};c.prototype.dumpContexts=function(){return L};q.exports=function(a){const b=new c;"loading"!=document.readyState?b.componentize():document.addEventListener("DOMContentLoaded",function(){b.componentize()});p.monitor(function(a,c){m.isFunction(b.monitor)&&b.monitor(a,Array.prototype.slice.call(c))});return b}},{"../helpers/Logger":2,"../helpers/ObjectObserver":3,
