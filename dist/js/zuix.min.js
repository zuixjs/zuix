...
"\n"}else v.w("z$.wrapCss was unable to parse rule.",k,f)}while(f);""!==c&&(a=c);return a};r.appendCss=function(d,a,b){const e=document.head||document.getElementsByTagName("head")[0];let c=null;u.isNoU(a)?(a=document.getElementById(b),null!=a&&e.removeChild(a)):e.removeChild(a);"string"===typeof d?(c=document.createElement("style"),c.type="text/css",c.id=b,c.styleSheet?c.styleSheet.cssText=d:c.appendChild(document.createTextNode(d))):d instanceof Element&&(c=d);u.isNoU(c)||e.appendChild(c);return c};
r.replaceCssVars=function(d,a){const b=new RegExp(/\B\$var\[(.*[^\[\]])]/g);let e="",c=0,f=0,k;for(;k=b.exec(d);){let b=k[0];if(1<k.length){var l=k[1];let d=a;if(0<l.indexOf(".")){l=l.split(".");for(let a=0;a<l.length-1&&(d=d[l[a]],"undefined"!==typeof d);a++);"undefined"!==typeof d&&(b=d[l[l.length-1]],c++)}else"undefined"!==typeof d[l]&&(b=d[l],c++)}e+=d.substr(f,k.index-f)+b;f=k.index+k[0].length}0<c&&(d=e+=d.substr(f));return d};r.replaceBraces=function(d,a){const b=new RegExp(/{?{.*?}?}/g);let e=
"",c=0,f=0;for(var k;k=b.exec(d);){if("string"===typeof k[0]&&(0===k[0].trim().length||0<=k[0].indexOf("\n"))){k=d.substr(f,k.index-f)+k[0];e+=k;f+=k.length;continue}let b=k[0];if("function"===typeof a){const d=a(k[0]);u.isNoU(d)||(b=d,c++)}e+=d.substr(f,k.index-f)+b;f=k.index+k[0].length}return 0<c?e+=d.substr(f):null};r.getClosest=function(d,a){for(d=d.parentNode;d&&d!==document;d=d.parentNode)if(d.matches(a))return d;return null};r.getPosition=function(d,a){var b;{var e=b=0,c=d.getBoundingClientRect();
...
a||c.top-1>e.bottom-a||c.bottom+1<e.top+a);b.visible=a;b.frame={dx:(c.left+c.width/2-e.left)/e.width,dy:(c.top+c.height/2-e.top)/e.height};d=l(d);!a&&d.hasClass("--ui--visible")?(d.removeClass("--ui--visible"),b.event="exit"):a?a&&(d.hasClass("--ui--visible")?b.event="scroll":(b.event="enter",d.addClass("--ui--visible"))):b.event="off-scroll"}return b};r.ZxQuery=a;Element.prototype.matches||(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.mozMatchesSelector||Element.prototype.msMatchesSelector||
Element.prototype.oMatchesSelector||Element.prototype.webkitMatchesSelector||function(d){d=(this.document||this.ownerDocument).querySelectorAll(d);let a=d.length;for(;0<=--a&&d.item(a)!==this;);return-1<a});(function(){function d(d,a){a=a||{bubbles:!1,cancelable:!1,detail:void 0};const b=document.createEvent("CustomEvent");b.initCustomEvent(d,a.bubbles,a.cancelable,a.detail);return b}if("function"===typeof window.CustomEvent)return!1;d.prototype=window.Event.prototype;window.CustomEvent=d})();String.prototype.hashCode=
function(){let a=0;if(0===this.length)return a;for(let d=0;d<this.length;d++){let b=this.charCodeAt(d);a=(a<<5)-a+b;a|=0}return a};String.prototype.startsWith||(String.prototype.startsWith=function(a,b){return this.substr(!b||0>b?0:+b,a.length)===a});q.exports=l},{"./Logger":2,"./Util.js":4}],6:[function(m,q,w){m=m("./zuix/Zuix.js");"object"===typeof q&&q.exports?q.exports=m.call(this):this.zuix=m.call(this)},{"./zuix/Zuix.js":16}],7:[function(m,q,w){function c(){this.observableList=[]}function g(a){let b=
"";for(;a&&a.__path__;){const c=a;a=a.__parents__[0];b=null!=a&&null!=a.__path__?"['"+c.__path__+"']."+b:c.__path__+(b.startsWith("[")?"":".")+b}return b}function f(a){const b=[];a.__parents__.forEach(function(a){b.push(...f(a))});b.push(...a.__listeners__);return b}function b(a){f(a).forEach(function(b){a.unsubscribe(b)})}m("./ObservableListener");const h=m("./ObservableObject");c.prototype.observable=function(a){let c;const m=this.observableList.filter(function(b){return a===b.proxy||a===b.target});
1===m.length&&(c=m[0]);null==c&&(c=new h(this,a,{context:null,get:function(a,b){if("observableTarget"===b)return a;let e=a[b];if("undefined"!==typeof e){var c=[],d=this.context.observable(a);if("object"===typeof e){const a=this.context.observable(e);-1===a.__parents__.indexOf(d)&&(a.__parents__.push(d),a.__path__=b);c.push(...f(a));e=a.proxy}else c.push(...f(d));var h=g(d)+b;c.forEach(function(d){d.get(a,b,e,h)});return e}},set:function(a,e,c){let k=JSON.parse(JSON.stringify(a));var d=a[e];"object"===
...
function r(b){h(b);b=a();null!=b&&N.append([b])}function v(a){var b=D(a);if(null!=b.attr(n.dataUiLoaded)||0<b.parent("pre,code").length())return!1;b.attr(n.dataUiLoaded,"true");let c=b.attr(n.dataUiOptions);p.isNoU(c)?c={}:(c=p.propertyFromPath(window,c),c=p.cloneObject(c)||{});var d=b.attr(n.dataUiContext);if(!p.isNoU(d)){var z=C.context(d);null!==z&&(c=z.options());c.contextId=d}p.isNoU(c.view)&&!b.isEmpty()?(c.view=a,c.viewDeferred=!0):p.isNoU(c.view)&&p.isNoU(c.container)&&b.isEmpty()&&(c.container=
a);d=b.attr(n.dataUiLoad);if(p.isNoU(d))if(d=b.attr(n.dataUiInclude),null!=d)d=u(d),b.attr(n.dataUiInclude,d),b.attr(n.dataUiComponent,""),p.isNoU(c.controller)&&(c.controller=function(){});else return!1;else d=u(d),b.attr(n.dataUiLoad,d);z=b.attr(n.dataBindModel);!p.isNoU(z)&&0<z.length&&(c.model=p.propertyFromPath(window,z));b=b.attr(n.dataUiPriority);p.isNoU(b)||(c.priority=+b);D(a).one("component:ready",function(){f(a);r(a)});C.load(d,c);return!0}function u(a){if("@"===a[0]){let b=C.store("config"),
...
a){y.splice(b,1);break}};c.prototype.setHost=function(a){C=a;return this};q.exports=function(){return new c};const t=m("../helpers/Logger")("ComponentContext.js"),p=m("../helpers/Util"),D=m("../helpers/ZxQuery"),F=[],y=[],x=[],B=[],M=function(){return{element:null,priority:0,visible:!0,lazy:!1}},N=m("./../helpers/AsynChain")({doWork:function(a,b){D(a.element).one("component:ready",function(){b()});return v(a.element)},willBreak:function(){return!1},status:function(a){switch(a){case "done":r()}}});
let K=!1,L=1,C=null,A=!1;navigator&&navigator.userAgent&&(A=(new RegExp(/bot|googlebot|crawler|spider|robot|crawling/i)).test(navigator.userAgent));A&&t.d(navigator.userAgent,"is a bot, ignoring `lazy-loading` option.");const H=[]},{"../helpers/Logger":2,"../helpers/Util":4,"../helpers/ZxQuery":5,"./../helpers/AsynChain":1,"./OptionAttributes":14}],13:[function(m,q,w){function c(c){const b=this;this._view=null;this.context=c;this._fieldCache=[];this._childNodes=[];this.saveView=function(){this.restoreView();
...
this._mutationObserver&&(this._mutationObserver.disconnect(),this._mutationObserver=null)};q.exports=c},{"../helpers/Util":4,"./OptionAttributes":14}],16:[function(m,q,w){function c(){x.setHost(this);this._store=[];this._fieldCache=[];return this}function g(a){"function"!==typeof a["for"]&&(a["for"]=function(b){return K[b]=a});return a}function f(a,b,c){t.isNoU(c)&&(c=this);null==c._fieldCache&&(c._fieldCache={});let d=null;"undefined"===typeof c._fieldCache[a]?(d=p(b).find(t.dom.queryAttribute(B.dataUiField,
a)),null!=d&&0<d.length()&&(c._fieldCache[a]=d,1===d.length()&&t.isNoU(d.field)&&(d.field=function(a){return f(a,d,d)}))):d=c._fieldCache[a];return d}function b(a){let b=zuix.store("config");null!=b&&null!=b[location.host]&&(b=b[location.host]);a=x.resolvePath(a);!a.startsWith("//")&&0>a.indexOf("://")&&(a=(null!=b&&null!=b.resourcePath?b.resourcePath:"")+a);return a}function h(a,b){let c=e(a.componentId);null!==c&&null==b.controller&&null==a.controller()&&(a.controller(c.controller),n.t(a.componentId+
":js","component:cached:js"));if(t.isNoU(b.view)){if(null!==c&&(null!=c.view&&(a.view(c.view),n.t(a.componentId+":html","component:cached:html")),!1!==b.css&&(b.css=!1,c.css_applied||(c.css_applied=!0,a.style(c.css),n.t(a.componentId+":css","component:cached:css")))),t.isNoU(a.view()))return H("resource-loader").queue(a.componentId+":html",function(){A[a.componentId]=this;a.loadHtml({cext:b.cext,caching:J,success:function(d){null==c&&(c=l(a));c.view=d;delete c.controller;!1!==b.css?(A[a.componentId].step(a.componentId+
":css"),a.loadCss({caching:J,success:function(a){c.css=a},error:function(b){n.e(b,a)},then:function(){k(a,A[a.componentId])}})):k(a,A[a.componentId])},error:function(c){n.e(c,a);t.isFunction(b.error)&&a.error.call(a,c,a)}})},b.priority),a}else a.view(b.view);null==a.controller()?H("resource-loader").queue(a.componentId+":js",function(){A[a.componentId]=this;k(a,A[a.componentId])},M.length):k(a);return a}function a(a){a=new F(zuix,a,v);M.push(a);return a}function r(a,b){let c=null;if(a instanceof p.ZxQuery)a=
a.get();else if("string"===typeof a){const b=p.find(t.dom.queryAttribute(B.dataUiContext,a));0<b.length()&&(a=b.get())}p.each(M,function(b,d){if(a instanceof Element&&(d.view()===a||d.container()===a)||t.objectEquals(d.contextId,a))return c=d,!1});if("function"===typeof b&&(a instanceof Element||a instanceof p.ZxQuery))if(null!=c&&c.isReady)b.call(c,c);else p(a).one("component:ready",function(){c=zuix.context(this);b.call(c,c)});return c}function v(a,b,c){t.isFunction(N[b])&&N[b].call(a,c,a)}function u(a){null!=
a&&(J=a);return J}function e(a){let b=null;p.each(I,function(c,d){if(t.objectEquals(d.componentId,a))return b=d,!1});return b}function k(a,c){if("undefined"===typeof a.options().controller&&null===a.controller())if(n.d(a.componentId,"controller:load"),t.isNoU(c)||c.step(a.componentId+":js"),t.isFunction(K[a.componentId]))a.controller(K[a.componentId]),d(a,c);else{const e=function(c){const e=a.componentId+".js"+(J?"":"?"+(new Date).getTime());p.ajax({url:b(e),success:function(b){try{const c=b.indexOf("function"),
d=b.indexOf(".load");1<d&&d<c&&(b=b.substring(0,d-4));const e=b.indexOf(".controller");1<e&&e<c&&(b=b.substring(e+11));const f=b.indexOf("//<--controller");0<f&&(b=b.substring(0,f));b+='\n//# sourceURL="'+a.componentId+'.js"\n';a.controller(O(b))}catch(Q){n.e(Error(),Q,b,a),t.isFunction(a.error)&&a.error.call(a,Q,a)}},error:function(b){n.e(b,Error(),a);t.isFunction(a.error)&&a.error.call(a,b,a)},then:function(){d(a,c)}})};t.isNoU(c)?H("resource-loader").queue(a.componentId+":js",function(){e(A[a.componentId]=
...
null!=b&&b.callback(function(){n.d(a.componentId,"controller:create:deferred");E(a._c)});var c=p(a.view());null==c.attr(B.dataUiContext)&&c.attr(B.dataUiContext,a.contextId);n.d(a.componentId,"component:initializing");if(t.isFunction(a.controller())){c=a._c=new y(a);c.log=m("../helpers/Logger")(a.contextId);"function"===typeof c.init&&c.init();if(!t.isNoU(c.view()))if(null==c.view().attr(B.dataUiComponent)&&c.view().attr(B.dataUiComponent,""),t.isNoU(a.model())&&!t.isNoU(a.view())&&a.viewToModel(),
...
e&&(e=0),e++,a.loadHtml({cext:a.options().cext,caching:J,success:function(b){null==d.view&&(d.view=b);n.d(a.componentId,"component:deferred:html",e)},error:function(b){n.e(b,a);t.isFunction(a.options().error)&&a.options().error.call(a,b,a)},then:function(){0===--e&&null!=b&&b.end()}})):a.view(d.view));-1===e&&null!=b&&b.end()}else null!=b&&b.end();c.trigger("view:apply");null==b&&(n.d(a.componentId,"controller:create"),E(c))}else n.w(a.componentId,"component:controller:undefined")}}function E(a){n.t(a.context.componentId,
"controller:init","timer:init:start");a.view().find(t.dom.queryAttribute(B.dataUiLoaded,"false",t.dom.cssNot(B.dataUiComponent))).each(function(a,b){this.attr(B.dataUiLoaded,null)});a.field=function(b){b=f(b,a.view(),a);b.on=function(b,c,d,e){if("string"===typeof c){const b=c;c=function(){a.trigger(b,d,e)}}return p.ZxQuery.prototype.on.call(this,b,c)};return b};t.isFunction(a.create)&&a.create();a.trigger("view:create");t.isFunction(a.context.ready)&&a.context.ready.call(a.context,a.context);a.trigger("component:ready",
a.view(),!0);a.context.isReady=!0;n.t(a.context.componentId,"controller:init","timer:init:stop");n.i(a.context.componentId,"component:loaded",a.context.contextId);if(null!=C[a.context.componentId]){const b=C[a.context.componentId];C[a.context.componentId]=null;let c;for(;null!=b&&null!=(c=b.shift());)h(c.c,c.o)}zuix.componentize(a.view())}function O(a){let b=function(a){};if("string"===typeof a)try{b=eval.call(this,a)}catch(S){n.e(this,S,a)}return b}const n=m("../helpers/Logger")("Zuix.js"),t=m("../helpers/Util"),
p=m("../helpers/ZxQuery"),D=m("../helpers/TaskQueue");w=m("../observable/ObjectObserver");const F=m("./ComponentContext"),y=m("./ContextController"),x=m("./Componentizer")(),B=m("./OptionAttributes");m("./ComponentCache");const M=[],N=[],K={},L=[],C={},A=[],H=function(a){t.isNoU(L[a])&&(L[a]=new D(function(a,b,c){v(a,b,c)}));return L[a]};let I=[],P=0,J=!0;const R=new w;c.prototype.field=function(a,b){return f.call(this,a,b)};c.prototype.load=function(b,c){{b=x.resolvePath(b);let d;t.isNoU(c)?(c={},
...
q.exports=function(a){const b=new c;"loading"!=document.readyState?b.componentize():document.addEventListener("DOMContentLoaded",function(){b.componentize()});n.monitor(function(a,c){t.isFunction(b.monitor)&&b.monitor(a,Array.prototype.slice.call(c))});return b}},{"../helpers/Logger":2,"../helpers/TaskQueue":3,"../helpers/Util":4,"../helpers/ZxQuery":5,"../observable/ObjectObserver":7,"./ComponentCache":10,"./ComponentContext":11,"./Componentizer":12,"./ContextController":13,"./OptionAttributes":14}]},
{},[6])(6)});
