...
function r(b){h(b);b=a();null!=b&&L.append([b])}function v(a){var b=D(a);if(null!=b.attr(n.dataUiLoaded)||0<b.parent("pre,code").length())return!1;b.attr(n.dataUiLoaded,"true");let c=b.attr(n.dataUiOptions);p.isNoU(c)?c={}:(c=p.propertyFromPath(window,c),c=p.cloneObject(c)||{});var d=b.attr(n.dataUiContext);if(!p.isNoU(d)){var z=C.context(d);null!==z&&(c=z.options());c.contextId=d}p.isNoU(c.view)&&!b.isEmpty()?(c.view=a,c.viewDeferred=!0):p.isNoU(c.view)&&p.isNoU(c.container)&&b.isEmpty()&&(c.container=
...
a){y.splice(b,1);break}};c.prototype.setHost=function(a){C=a;return this};q.exports=function(){return new c};const t=m("../helpers/Logger")("ComponentContext.js"),p=m("../helpers/Util"),D=m("../helpers/ZxQuery"),F=[],y=[],x=[],B=[],K=function(){return{element:null,priority:0,visible:!0,lazy:!1}},L=m("./../helpers/AsynChain")({doWork:function(a,b){D(a.element).one("component:ready",function(){b()});return v(a.element)},willBreak:function(){return!1},status:function(a){switch(a){case "done":r()}}});
let M=!1,N=1,C=null,A=!1;navigator&&navigator.userAgent&&(A=(new RegExp(/bot|googlebot|crawler|spider|robot|crawling/i)).test(navigator.userAgent));A&&t.d(navigator.userAgent,"is a bot, ignoring `lazy-loading` option.");const H=[]},{"../helpers/Logger":2,"../helpers/Util":4,"../helpers/ZxQuery":5,"./../helpers/AsynChain":1,"./OptionAttributes":14}],13:[function(m,q,w){function c(c){const b=this;this._view=null;this.context=c;this._fieldCache=[];this._childNodes=[];this.saveView=function(){this.restoreView();
...
this._mutationObserver&&(this._mutationObserver.disconnect(),this._mutationObserver=null)};q.exports=c},{"../helpers/Util":4,"./OptionAttributes":14}],16:[function(m,q,w){function c(){x.setHost(this);this._store=[];this._fieldCache=[];return this}function g(a){"function"!==typeof a["for"]&&(a["for"]=function(b){return M[b]=a});return a}function f(a,b,c){t.isNoU(c)&&(c=this);null==c._fieldCache&&(c._fieldCache={});let d=null;"undefined"===typeof c._fieldCache[a]?(d=p(b).find(t.dom.queryAttribute(B.dataUiField,
...
":css"),a.loadCss({caching:J,success:function(a){c.css=a},error:function(b){n.e(b,a)},then:function(){k(a,A[a.componentId])}})):k(a,A[a.componentId])},error:function(c){n.e(c,a);t.isFunction(b.error)&&a.error.call(a,c,a)}})},b.priority),a}else a.view(b.view);null==a.controller()?H("resource-loader").queue(a.componentId+":js",function(){A[a.componentId]=this;k(a,A[a.componentId])},K.length):k(a);return a}function a(a){a=new F(zuix,a,v);K.push(a);return a}function r(a,b){let c=null;if(a instanceof p.ZxQuery)a=
a.get();else if("string"===typeof a){const b=p.find(t.dom.queryAttribute(B.dataUiContext,a));0<b.length()&&(a=b.get())}p.each(K,function(b,d){if(a instanceof Element&&(d.view()===a||d.container()===a)||t.objectEquals(d.contextId,a))return c=d,!1});if("function"===typeof b&&(a instanceof Element||a instanceof p.ZxQuery))if(null!=c&&c.isReady)b.call(c,c);else p(a).one("component:ready",function(){c=zuix.context(this);b.call(c,c)});return c}function v(a,b,c){t.isFunction(L[b])&&L[b].call(a,c,a)}function u(a){null!=
a&&(J=a);return J}function e(a){let b=null;p.each(I,function(c,d){if(t.objectEquals(d.componentId,a))return b=d,!1});return b}function k(a,c){if("undefined"===typeof a.options().controller&&null===a.controller())if(n.d(a.componentId,"controller:load"),t.isNoU(c)||c.step(a.componentId+":js"),t.isFunction(M[a.componentId]))a.controller(M[a.componentId]),d(a,c);else{const e=function(c){const e=a.componentId+".js"+(J?"":"?"+(new Date).getTime());p.ajax({url:b(e),success:function(b){try{const c=b.indexOf("function"),
...
p=m("../helpers/ZxQuery"),D=m("../helpers/TaskQueue");w=m("../observable/ObjectObserver");const F=m("./ComponentContext"),y=m("./ContextController"),x=m("./Componentizer")(),B=m("./OptionAttributes");m("./ComponentCache");const K=[],L=[],M={},N=[],C={},A=[],H=function(a){t.isNoU(N[a])&&(N[a]=new D(function(a,b,c){v(a,b,c)}));return N[a]};let I=[],P=0,J=!0;const R=new w;c.prototype.field=function(a,b){return f.call(this,a,b)};c.prototype.load=function(b,c){{b=x.resolvePath(b);let d;t.isNoU(c)?(c={},
